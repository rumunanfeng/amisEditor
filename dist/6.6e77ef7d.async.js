    ...
    TWxf: function (t, e, i) {
      ...
      var c = function (t, e) {
          ...
          a ? t.enable() : t.disable(),
            t.scaleX(o),
            t.scaleY(h),
            void 0 !== l && t.rotateTo(l),
            c > 0 && t.zoomTo(c);
        },
        l = function () {
          for (var t = [], e = 0; e < arguments.length; e++)
            t[e] = arguments[e];
          var i = Object(a['useRef'])(null);
          return (
            n.a.useEffect(
              function () {
        ...
        d = n.a.forwardRef(function (t, e) {
          var i = s(t, []),
            ...
            T = { scaleY: v, scaleX: f, enable: w, zoomTo: b, rotateTo: y },
            ...
            Object(a['useEffect'])(
              function () {
                ...
                (null === (t = B.current) || void 0 === t
                  ...
                  : t.cropper) &&
                  'undefined' !== typeof p &&
                  B.current.cropper.reset().clear().replace(p);
              },
              [p],
            ),
            Object(a['useEffect'])(
    ...
    urRO: function (t, e, i) {
      (function (e, i) {
        ...
        var u =
          ...
          J = g ? 'touchend touchcancel' : 'mouseup',
          G = f ? 'pointerdown' : K,
          V = f ? 'pointermove' : Z,
          F = f ? 'pointerup pointercancel' : J,
          _ = 'ready',
          tt = 'resize',
          et = 'wheel',
          it = 'zoom',
        ...
        function kt(t, e) {
          var i = t.style;
          Mt(e, function (t, e) {
            Tt.test(e) && ut(t) && (t = ''.concat(t, 'px')), (i[e] = t);
          });
        }
        function Bt(t, e) {
          return t.classList
        ...
        function _t(t, e, i, a) {
          var n = e.aspectRatio,
            ...
            z = N.getContext('2d'),
            H = Vt({ aspectRatio: m, width: D, height: T }),
            Y = Vt({ aspectRatio: m, width: B, height: W }, 'cover'),
            L = Math.min(H.width, Math.max(Y.width, g)),
            X = Math.min(H.height, Math.max(Y.height, f)),
            R = Vt({ aspectRatio: n, width: D, height: T }),
            j = Vt({ aspectRatio: n, width: B, height: W }, 'cover'),
            S = Math.min(R.width, Math.max(j.width, o)),
            A = Math.min(R.height, Math.max(j.height, r)),
            I = [-S / 2, -A / 2, S, A];
          return (
            (N.width = Ot(L)),
            (N.height = Ot(X)),
            ...
            z.save(),
            z.translate(L / 2, X / 2),
            z.rotate((c * Math.PI) / 180),
            z.scale(d, u),
            (z.imageSmoothingEnabled = y),
          ...
          try {
            ...
            if (o) {
              var p,
                ...
                m = i.getUint16(o, a);
              for (u = 0; u < m; u += 1)
                if (((p = o + 12 * u + 2), 274 === i.getUint16(p, a))) {
        ...
        var he = {
            ...
            initContainer: function () {
              ...
              (this.containerData = r),
                kt(a, { width: r.width, height: r.height }),
                Et(t, z),
                Wt(a, z);
            },
            initCanvas: function () {
                  ...
                  : r > 0 &&
                    (c
                      ...
                      : s &&
                        ...
                        (l = o.height),
                        l * h > c ? (c = l * h) : (l = c / h)));
                var d = Vt({ aspectRatio: h, width: c, height: l });
                (c = d.width),
                  (l = d.height),
                  (n.minWidth = c),
                  (n.minHeight = l),
          ...
          se = {
            ...
            resetPreview: function () {
              Mt(this.previews, function (t) {
                var e = Yt(t, j);
                kt(t, { width: e.width, height: e.height }),
                  (t.innerHTML = e.html),
                  Xt(t, j);
              });
            },
              ...
              this.cropped &&
                ...
                Mt(this.previews, function (e) {
                  var i = Yt(e, j),
                    ...
                    u = 1;
                  a && ((u = c / a), (p = n * u)),
                    n && p > l && ((u = l / n), (d = a * u), (p = l)),
                    kt(e, { width: d, height: p }),
                    kt(
          ...
          ce = {
            bind: function () {
              ...
              bt(e.cropstart) && At(t, $, e.cropstart),
                ...
                At(i, G, (this.onCropStart = this.cropStart.bind(this))),
                e.zoomable &&
                  e.zoomOnWheel &&
                  At(i, et, (this.onWheel = this.wheel.bind(this)), {
                    passive: !1,
                    capture: !0,
                  }),
                e.toggleDragModeOnDblclick &&
                  At(i, Q, (this.onDblclick = this.dblclick.bind(this))),
                At(
                  t.ownerDocument,
                  V,
                ...
                e.responsive &&
                  At(window, tt, (this.onResize = this.resize.bind(this)));
            },
            unbind: function () {
              var t = this.element,
                e = this.options,
                i = this.cropper;
              bt(e.cropstart) && St(t, $, e.cropstart),
                bt(e.cropmove) && St(t, q, e.cropmove),
                bt(e.cropend) && St(t, U, e.cropend),
                bt(e.crop) && St(t, P, e.crop),
                bt(e.zoom) && St(t, it, e.zoom),
                St(i, G, this.onCropStart),
                e.zoomable &&
                  e.zoomOnWheel &&
                  St(i, et, this.onWheel, { passive: !1, capture: !0 }),
                e.toggleDragModeOnDblclick && St(i, Q, this.onDblclick),
                St(t.ownerDocument, V, this.onCropMove),
                St(t.ownerDocument, F, this.onCropEnd),
                e.responsive && St(window, tt, this.onResize);
            },
          },
          le = {
            resize: function () {
            ...
            dblclick: function () {
              this.disabled ||
                ...
                this.setDragMode(Bt(this.dragBox, W) ? A : S);
            },
            wheel: function (t) {
              var e = this,
            ...
            cropStart: function (t) {
              ...
              if (
                ...
                t.changedTouches
                  ...
                  nt.test(a) &&
                    !1 !==
                      It(this.element, $, { originalEvent: t, action: a }) &&
                    (t.preventDefault(),
                    (this.action = a),
                    (this.cropping = !1),
                    a === b && ((this.cropping = !0), Et(this.dragBox, L)));
              }
            },
            cropMove: function (t) {
              var e = this.action;
              if (!this.disabled && e) {
                ...
                t.preventDefault(),
                  !1 !== It(this.element, q, { originalEvent: t, action: e }) &&
                    (t.changedTouches
                      ? Mt(t.changedTouches, function (t) {
                          Ct(i[t.identifier] || {}, Jt(t, !0));
                        })
                      : Ct(i[t.pointerId || 0] || {}, Jt(t, !0)),
                    this.change(t));
              }
            },
            cropEnd: function (t) {
              if (!this.disabled) {
                ...
                t.changedTouches
                  ...
                  e &&
                    ...
                    this.cropping &&
                      ((this.cropping = !1),
                      Nt(this.dragBox, L, this.cropped && this.options.modal)),
          ...
          de = {
            change: function (t) {
              ...
              var H = r[Object.keys(r)[0]],
                Y = { x: H.endX - H.startX, y: H.endY - H.startY },
                L = function (t) {
                  switch (t) {
                    case M:
                      u + Y.x > v && (Y.x = v - u);
              ...
              switch (h) {
                ...
                case B:
                  ...
                  break;
                case y:
                  this.move(Y.x, Y.y), (N = !1);
                  break;
                case x:
                  this.zoom(Zt(r), t), (N = !1);
                  break;
                case b:
                  if (!Y.x || !Y.y) {
                    N = !1;
          ...
          pe = {
            crop: function () {
              return (
                !this.ready ||
                  ...
                  ((this.cropped = !0),
                  this.limitCropBox(!0, !0),
                  this.options.modal && Et(this.dragBox, L),
                  Wt(this.cropBox, z),
            ...
            enable: function () {
              return (
                this.ready &&
                  this.disabled &&
                  ((this.disabled = !1), Wt(this.cropper, N)),
                this
              );
            },
            disable: function () {
              return (
                this.ready &&
                  !this.disabled &&
                  ((this.disabled = !0), Et(this.cropper, N)),
                this
              );
            },
            destroy: function () {
            ...
            getCroppedCanvas: function () {
              ...
              E <= -r || E > k
                ? ((E = 0), (x = 0), (C = 0), (O = 0))
                : E <= 0
                ? ((C = -E), (E = 0), (x = Math.min(k, r + E)), (O = x))
                : E <= k && ((C = 0), (x = Math.min(r, k - E)), (O = x)),
                x <= 0 || W <= -s || W > B
                  ? ((W = 0), (M = 0), (D = 0), (T = 0))
                  : W <= 0
                  ? ((D = -W), (W = 0), (M = Math.min(B, s + W)), (T = M))
                  : W <= B && ((D = 0), (M = Math.min(s, B - W)), (T = M));
              var N = [E, W, x, M];
              if (O > 0 && T > 0) {
                var z = m / r;
                N.push(C * z, D * z, O * z, T * z);
              }
              return (
                v.drawImage.apply(
                  v,
            ...
            setDragMode: function (t) {
              ...
              if (this.ready && !this.disabled) {
                ...
                (t = n || o ? t : I),
                  ...
                  Nt(i, W, n),
                  Nt(i, X, o),
                  e.cropBoxMovable || (Lt(a, R, t), Nt(a, W, n), Nt(a, X, o));
              }
              return this;
            },
          },
                    ...
                    value: function () {
                      if (this.sized && !this.ready) {
                        ...
                        (this.container = a),
                          ...
                          e.highlight || Et(c, Y),
                          e.cropBoxMovable && (Et(c, X), Lt(c, R, w)),
                          e.cropBoxResizable ||
                            (Et(
                          ...
                          this.setData(e.data),
                          bt(e.ready) && At(t, _, e.ready, { once: !0 }),
                          It(t, _);
                      }
                    },
                  },
