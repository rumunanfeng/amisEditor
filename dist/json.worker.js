(function (e) {
  ...
  '8Z8O': function (e, t, n) {
    ...
    function m(e) {
      return null === f || void 0 === f || f.trackDisposable(e), e;
    }
    function g(e) {
      null === f || void 0 === f || f.markAsDisposed(e);
    }
    function p(e, t) {
      null === f || void 0 === f || f.setParent(e, t);
    }
    function v(e, t) {
    ...
    class S {
      constructor() {
        (this._toDispose = new Set()), (this._isDisposed = !1), m(this);
      }
      dispose() {
    ...
    class w {
      constructor() {
        (this._store = new S()), m(this), p(this._store, this);
      }
      dispose() {
    ...
    class E {
      ...
      _remove(e) {
        if (e.prev !== A.Undefined && e.next !== A.Undefined) {
          ...
          e.prev === A.Undefined && e.next === A.Undefined
            ? ((this._first = A.Undefined), (this._last = A.Undefined))
            : e.next === A.Undefined
            ? ((this._last = this._last.prev), (this._last.next = A.Undefined))
            : e.prev === A.Undefined &&
      ...
      *[Symbol.iterator]() {
        let e = this._first;
        while (e !== A.Undefined) yield e.element, (e = e.next);
      }
    }
    var N = n('MNsG');
    const x =
      N['a'].performance && 'function' === typeof N['a'].performance.now;
    class L {
      constructor(e) {
        (this._highResolution = x && e),
    ...
    (function (e) {
      ...
      function s(...e) {
        return (t, n = null, r) =>
          _(...e.map((e) => e((e) => t.call(n, e), null, r)));
      }
      function a(e, t, r) {
        let i = r;
      ...
      function g(e, t, n = (e) => e) {
        const r = (...e) => s.fire(n(...e)),
          ...
          s = new M({ onFirstListenerAdd: i, onLastListenerRemove: o });
        return s.event;
      }
      function p(e, t, n = (e) => e) {
        const r = (...e) => s.fire(n(...e)),
    ...
    class T {
      constructor(e) {
        (this._listenerCount = 0),
          ...
          (this._name = `${e}_${T._idPool++}`);
      }
      start(e) {
        (this._stopWatch = new L(!0)), (this._listenerCount = e);
      }
      stop() {
        if (this._stopWatch) {
    ...
    class M {
      constructor(e) {
        ...
        (this._disposed = !1),
          ...
          (this._leakageMon =
            O > 0
              ? new I(this._options && this._options.leakWarningThreshold)
              : void 0),
          (this._perfMon = (
      ...
      get event() {
        return (
          this._event ||
            (this._event = (e, t, n) => {
              var r;
              this._listeners || (this._listeners = new E());
              ...
              return (
                n instanceof S ? n.add(a) : Array.isArray(n) && n.push(a), a
              );
            }),
          this._event
        );
      ...
      fire(e) {
        var t, n;
        if (this._listeners) {
          this._deliveryQueue || (this._deliveryQueue = new E());
    ...
    function V(e) {
      const t = [];
      for (const n of P(e)) 'function' === typeof e[n] && t.push(n);
      return t;
    }
    function R(e, t) {
      const n = (e) =>
    ...
    class Q {
        ...
        const r = new M({
          onFirstListenerAdd: () => {
            (n = String(++this._lastSentReq)),
              ...
              this._send(new J(this._workerId, n, e, t));
          },
          onLastListenerRemove: () => {
            this._pendingEmitters.delete(n),
              this._send(new Z(this._workerId, n)),
              (n = null);
          },
        });
        return r.event;
      ...
      _handleRequestMessage(e) {
        ...
        n.then(
          (e) => {
            this._send(new G(this._workerId, t, e, void 0));
          },
          (e) => {
            e.detail instanceof Error && (e.detail = s(e.detail)),
              this._send(new G(this._workerId, t, void 0, s(e)));
          },
        );
      }
      _handleSubscribeEventMessage(e) {
        const t = e.req,
          n = this._handler.handleEvent(
            ...
            this._send(new X(this._workerId, t, e));
          });
    ...
    function Y(e) {
      return 'o' === e[0] && 'n' === e[1] && j(e.charCodeAt(2));
    }
    function ee(e) {
      return /^onDynamic/.test(e) && j(e.charCodeAt(9));
    }
    function te(e, t, n) {
      const r = (e) =>
          function () {
      ...
      let o = {};
      for (const s of e)
        ee(s) ? (o[s] = i(s)) : Y(s) ? (o[s] = n(s, void 0)) : (o[s] = r(s));
      return o;
    }
    class ne {
      constructor(e, t) {
      ...
      _handleMessage(e, t) {
        if (e === H) return this.initialize(t[0], t[1], t[2], t[3]);
        if (
          ...
          : (t &&
            ...
            new Promise((e, t) => {
              ...
              r(
                [n],
                (n) => {
                  (this._requestHandler = n.create(s)),
                    this._requestHandler
    ...
    function se(e, t, n = 32) {
      const r = n - t,
        i = ~((1 << r) - 1);
      return ((e << t) | ((i & e) >>> r)) >>> 0;
    }
    function ae(e, t = 0, n = e.byteLength, r = 0) {
    ...
    class ce {
      ...
      _wrapUp() {
        (this._buff[this._buffLen++] = 128),
          ae(this._buff, this._buffLen),
          this._buffLen > 56 && (this._step(), ae(this._buff));
      ...
      _step() {
        ...
        for (let c = 0; c < 80; c++)
          c < 20
            ...
            (i = (se(o, 5) + n + l + r + e.getUint32(4 * c, !1)) & 4294967295),
            (l = u),
            (u = a),
            (a = se(s, 30)),
            (s = o),
    ...
    function fe(e, t, n) {
      return new pe(new he(e), new he(t)).ComputeDiff(n).changes;
    }
    class de {
      static Assert(e, t) {
    ...
    class pe {
      constructor(e, t, n = null) {
        ...
        const [r, i, o] = pe._getElements(e),
          [s, a, u] = pe._getElements(t);
      ...
      static _getElements(e) {
        ...
        if (pe._isStringArray(t)) {
          const e = new Int32Array(t.length);
          for (let n = 0, r = t.length; n < r; n++) e[n] = oe(t[n], 0);
          return [t, e, !0];
        }
      ...
      ElementsAreStrictEqual(e, t) {
        ...
        const n = pe._getStrictElement(this._originalSequence, e),
          r = pe._getStrictElement(this._modifiedSequence, t);
        return n === r;
      }
      ...
      ComputeRecursionPoint(e, t, n, r, i, o, s) {
        ...
        for (let w = 1; w <= d / 2 + 1; w++) {
          let d = 0,
            C = 0;
          (l = this.ClipDiagonalBound(v - w, w, v, m)),
            (c = this.ClipDiagonalBound(v + w, w, v, m));
          for (let e = l; e <= c; e += 2) {
            (a =
              e === l || (e < c && g[e - 1] < g[e + 1])
                ? g[e + 1]
              ...
              (u = a - (e - v) - b);
            const n = a;
            while (a < t && u < r && this.ElementsAreEqual(a + 1, u + 1))
              a++, u++;
            if (
              ((g[e] = a),
              a + u > d + C && ((d = a), (C = u)),
              !S && Math.abs(e - y) <= w - 1 && a >= p[e])
            )
              return (
                (i[0] = a),
                (o[0] = u),
          ...
          if (
            ...
            !this.ContinueProcessingPredicate(d, A)
          )
            return (
              (s[0] = !0),
              (i[0] = d),
              ...
              A > 0 && w <= 1448
                ...
                : (e++, n++, [new re(e, t - e + 1, n, r - n + 1)])
            );
          (h = this.ClipDiagonalBound(y - w, w, y, m)),
            (f = this.ClipDiagonalBound(y + w, w, y, m));
          for (let m = h; m <= f; m += 2) {
            (a =
              m === h || (m < f && p[m - 1] >= p[m + 1])
                ? p[m + 1] - 1
      ...
      ConcatenateChanges(e, t) {
        ...
        if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
          ...
          return (
            me.Copy(e, 0, r, 0, e.length - 1),
            (r[e.length - 1] = n[0]),
            me.Copy(t, 1, r, e.length, t.length - 1),
            r
          );
        }
        {
          ...
          return (
            me.Copy(e, 0, n, 0, e.length),
            me.Copy(t, 0, n, e.length, t.length),
            n
          );
        }
      }
    ...
    const Pe = {
        resolve(...e) {
          ...
          for (let i = e.length - 1; i >= -1; i--) {
            let o;
            if (i >= 0) {
              if (((o = e[i]), Le(o, 'path'), 0 === o.length)) continue;
            } else
              0 === t.length
                ? (o = ve['a']())
                : ((o = ve['b'][`=${t}`] || ve['a']()),
            ...
            if (1 === s) ke(c) && ((a = 1), (l = !0));
              ...
              if (((l = !0), ke(o.charCodeAt(1)))) {
                let e = 2,
                  t = e;
                while (e < s && !ke(o.charCodeAt(e))) e++;
                if (e < s && e !== t) {
                  const n = o.slice(t, e);
                  t = e;
                  while (e < s && ke(o.charCodeAt(e))) e++;
        ...
        normalize(e) {
          ...
          if (1 === t) return Te(o) ? '\\' : e;
          if (ke(o))
            if (((i = !0), ke(e.charCodeAt(1)))) {
              let i = 2,
                o = i;
              while (i < t && !ke(e.charCodeAt(i))) i++;
              if (i < t && i !== o) {
                const s = e.slice(o, i);
                o = i;
                while (i < t && ke(e.charCodeAt(i))) i++;
            ...
            Oe(o) &&
              ...
              ((n = e.slice(0, 2)),
              (r = 2),
              t > 2 && ke(e.charCodeAt(2)) && ((i = !0), (r = 3)));
          let s = r < t ? Ie(e.slice(r), !i, '\\', ke) : '';
          return (
            0 !== s.length || i || (s = '.'),
            s.length > 0 && ke(e.charCodeAt(t - 1)) && (s += '\\'),
        ...
        isAbsolute(e) {
          ...
          return (
            ke(n) ||
            (t > 2 && Oe(n) && e.charCodeAt(1) === Ee && ke(e.charCodeAt(2)))
          );
        },
        join(...e) {
          ...
          if ('string' === typeof n && ke(n.charCodeAt(0))) {
            ...
            e > 1 &&
              ke(n.charCodeAt(1)) &&
              (++i, e > 2 && (ke(n.charCodeAt(2)) ? ++i : (r = !1)));
          }
          if (r) {
            while (i < t.length && ke(t.charCodeAt(i))) i++;
            i >= 2 && (t = `\\${t.slice(i)}`);
          }
          return Pe.normalize(t);
        },
        relative(e, t) {
          if ((Le(e, 'from'), Le(t, 'to'), e === t)) return '';
          ...
          if (((e = n.toLowerCase()), (t = r.toLowerCase()), e === t))
            return '';
          let i = 0;
          while (i < e.length && e.charCodeAt(i) === Ae) i++;
          let o = e.length;
          while (o - 1 > i && e.charCodeAt(o - 1) === Ae) o--;
          const s = o - i;
          let a = 0;
          while (a < t.length && t.charCodeAt(a) === Ae) a++;
          let u = t.length;
          while (u - 1 > a && t.charCodeAt(u - 1) === Ae) u--;
          const l = u - a,
            c = s < l ? s : l;
          let h = -1,
            f = 0;
          ...
          if (f !== c) {
            ...
            if (l > c) {
              if (t.charCodeAt(a + f) === Ae) return r.slice(a + f + 1);
              if (2 === f) return r.slice(a + f);
            }
            s > c &&
              (e.charCodeAt(i + f) === Ae ? (h = f) : 2 === f && (h = 3)),
              -1 === h && (h = 0);
          }
          let d = '';
          for (f = i + h + 1; f <= o; ++f)
            (f !== o && e.charCodeAt(f) !== Ae) ||
              (d += 0 === d.length ? '..' : '\\..');
          return (
            (a += h),
            d.length > 0
              ? `${d}${r.slice(a, u)}`
              : (r.charCodeAt(a) === Ae && ++a, r.slice(a, u))
          );
        },
        toNamespacedPath(e) {
          ...
          if (t.charCodeAt(0) === Ae) {
            if (t.charCodeAt(1) === Ae) {
              ...
              if (e !== Ne && e !== Se) return `\\\\?\\UNC\\${t.slice(2)}`;
            }
          } else if (
            Oe(t.charCodeAt(0)) &&
            t.charCodeAt(1) === Ee &&
        ...
        dirname(e) {
          ...
          if (ke(i)) {
            ...
            Oe(i) &&
              e.charCodeAt(1) === Ee &&
              ((n = t > 2 && ke(e.charCodeAt(2)) ? 3 : 2), (r = n));
          let o = -1,
            s = !0;
          for (let a = t - 1; a >= r; --a)
            if (ke(e.charCodeAt(a))) {
              if (!s) {
                o = a;
                break;
              }
        ...
        parse(e) {
          ...
          } else if (Oe(i) && e.charCodeAt(1) === Ee) {
      ...
      Ve = {
        resolve(...e) {
          ...
          for (let r = e.length - 1; r >= -1 && !n; r--) {
            const i = r >= 0 ? e[r] : ve['a']();
            Le(i, 'path'),
              0 !== i.length &&
                ((t = `${i}/${t}`), (n = i.charCodeAt(0) === we));
          }
          return (t = Ie(t, !n, '/', Te)), n ? `/${t}` : t.length > 0 ? t : '.';
        },
        normalize(e) {
          if ((Le(e, 'path'), 0 === e.length)) return '.';
        ...
        isAbsolute(e) {
          return Le(e, 'path'), e.length > 0 && e.charCodeAt(0) === we;
        },
        join(...e) {
          if (0 === e.length) return '.';
          let t;
          ...
          return void 0 === t ? '.' : Ve.normalize(t);
        },
        relative(e, t) {
          if ((Le(e, 'from'), Le(t, 'to'), e === t)) return '';
          if (((e = Ve.resolve(e)), (t = Ve.resolve(t)), e === t)) return '';
          const n = 1,
            r = e.length,
            i = r - n,
            o = 1,
          ...
          if (l === a)
            if (s > a) {
              if (t.charCodeAt(o + l) === we) return t.slice(o + l + 1);
              if (0 === l) return t.slice(o + l);
            } else
              i > a &&
                (e.charCodeAt(n + l) === we ? (u = l) : 0 === l && (u = 0));
          let c = '';
          for (l = n + u + 1; l <= r; ++l)
            (l !== r && e.charCodeAt(l) !== we) ||
              (c += 0 === c.length ? '..' : '/..');
    ...
    (Ve.win32 = Pe.win32 = Pe), (Ve.posix = Pe.posix = Ve);
    'win32' === ve['c'] ? Pe.normalize : Ve.normalize,
      'win32' === ve['c'] ? Pe.resolve : Ve.resolve,
      'win32' === ve['c'] ? Pe.relative : Ve.relative,
      'win32' === ve['c'] ? Pe.dirname : Ve.dirname,
      'win32' === ve['c'] ? Pe.basename : Ve.basename,
      'win32' === ve['c'] ? Pe.extname : Ve.extname,
      'win32' === ve['c'] ? Pe.sep : Ve.sep;
    const Re = /^\w[\w\d+.-]*$/,
      Fe = /^\//,
      De = /^\/\//;
    function Ke(e, t) {
    ...
    class We {
      constructor(e, t, n, r, i, o = !1) {
        'object' === typeof e
          ? ((this.scheme = e.scheme || $e),
            (this.authority = e.authority || $e),
            (this.path = e.path || $e),
            (this.query = e.query || $e),
            (this.fragment = e.fragment || $e))
          : ((this.scheme = je(e, o)),
            (this.authority = t || $e),
            (this.path = Ue(this.scheme, n || $e)),
            (this.query = r || $e),
            (this.fragment = i || $e),
            Ke(this, o));
      }
      ...
      with(e) {
        ...
        return (
          ...
          void 0 === n ? (n = this.authority) : null === n && (n = $e),
      ...
      static file(e) {
        let t = $e;
        if (
          (N['d'] && (e = e.replace(/\\/g, Be)), e[0] === Be && e[1] === Be)
        ) {
          const n = e.indexOf(Be, 2);
          -1 === n
            ? ((t = e.substring(2)), (e = Be))
            : ((t = e.substring(2, n)), (e = e.substring(n) || Be));
        }
        return new ze('file', t, e, $e, $e);
      }
      static from(e) {
        const t = new ze(e.scheme, e.authority, e.path, e.query, e.fragment);
        return Ke(t, !0), t;
      }
      static joinPath(e, ...t) {
        if (!e.path)
        ...
        if (e) {
          if (e instanceof We) return e;
          {
            ...
            return (
              ...
              (t._fsPath = e._sep === He ? e.fsPath : null),
              t
            );
          }
        }
    ...
    const He = N['d'] ? 1 : void 0;
    class ze extends We {
      constructor() {
        super(...arguments), (this._formatted = null), (this._fsPath = null);
      }
      get fsPath() {
        return this._fsPath || (this._fsPath = Ze(this, !1)), this._fsPath;
      }
      toString(e = !1) {
        return e
          ? Qe(this, !0)
          : (this._formatted || (this._formatted = Qe(this, !1)),
            this._formatted);
      }
      toJSON() {
        const e = { $mid: 1 };
        return (
          this._fsPath && ((e.fsPath = this._fsPath), (e._sep = He)),
    ...
    function Xe(e) {
      ...
      for (let n = 0; n < e.length; n++) {
        ...
        35 === r || 63 === r
          ? (void 0 === t && (t = e.substr(0, n)), (t += Ge[r]))
          : void 0 !== t && (t += e[n]);
      }
      return void 0 !== t ? t : e;
    }
    ...
    function Ye(e) {
      try {
        ...
        return e.length > 3 ? e.substr(0, 3) + Ye(e.substr(3)) : e;
      }
    }
    const et = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
    function tt(e) {
      return e.match(et) ? e.replace(et, (e) => Ye(e)) : e;
    }
    class nt {
      constructor(e, t) {
    ...
    class rt {
      ...
      containsPosition(e) {
        return rt.containsPosition(this, e);
      }
      ...
      containsRange(e) {
        return rt.containsRange(this, e);
      }
      ...
      strictContainsRange(e) {
        return rt.strictContainsRange(this, e);
      }
      ...
      intersectRanges(e) {
        return rt.intersectRanges(this, e);
      }
      static intersectRanges(e, t) {
        ...
        return (
          ...
          n > i || (n === i && r > o) ? null : new rt(n, r, i, o)
        );
      }
      equalsRange(e) {
        return rt.equalsRange(this, e);
      }
      ...
      setEndPosition(e, t) {
        return new rt(this.startLineNumber, this.startColumn, e, t);
      }
      setStartPosition(e, t) {
        return new rt(e, t, this.endLineNumber, this.endColumn);
      }
      collapseToStart() {
        return rt.collapseToStart(this);
      }
      ...
      static fromPositions(e, t = e) {
        return new rt(e.lineNumber, e.column, t.lineNumber, t.column);
      }
      static lift(e) {
        return e
          ? new rt(
    ...
    class ct {
      ...
      static createFromDiffResult(e, t, n, r, i, o, s) {
        ...
        if (
          ...
          let u = ot(o, a, i, !0).changes;
          s && (u = lt(u)), (h = []);
          for (let e = 0, t = u.length; e < t; e++)
            h.push(ut.createFromDiffChange(u[e], o, a));
        }
        return new ct(a, u, l, c, h);
      }
    }
    class ht {
      constructor(e, t, n) {
        (this.shouldComputeCharChanges = n.shouldComputeCharChanges),
          ...
          (this.original = new st(e)),
          (this.modified = new st(t)),
          (this.continueLineDiff = mt(n.maxComputationTime)),
          (this.continueCharDiff = mt(
      ...
      _pushTrimWhitespaceCharChange(e, t, n, r, i, o, s) {
        ...
        let a;
        this.shouldComputeCharChanges && (a = [new ut(t, n, t, r, i, o, i, s)]),
          e.push(new ct(t, t, i, i, a));
      }
      _mergeTrimWhitespaceCharChange(e, t, n, r, i, o, s) {
        ...
        return (
          ...
          this.shouldComputeCharChanges &&
            u.charChanges &&
            u.charChanges.push(new ut(t, n, t, r, i, o, i, s)),
          !0)
        );
      }
    }
    ...
    class yt {
      ...
      getPrefixSum(e) {
        return e < 0 ? 0 : ((e = pt(e)), this._getPrefixSum(e));
      }
      _getPrefixSum(e) {
    ...
    function Ct(e = '') {
      let t = '(-?\\d*\\.\\d\\w*)|([^';
      for (const n of _t) e.indexOf(n) >= 0 || (t += '\\' + n);
    ...
    const At = { maxLen: 1e3, windowSize: 15, timeBudget: 150 };
    function Et(e, t, n, r, i = At) {
    ...
    class xt {
      constructor(e) {
        ...
        (this._defaultValue = t),
          (this._asciiMap = xt._createAsciiMap(t)),
          (this._map = new Map());
      }
        ...
        for (let i = 1, o = e.getLineCount(); i <= o; i++) {
          ...
          while (a < s) {
            ...
            if (13 === c) {
              ...
              1 === t && (r.push(Pt._createLink(n, o, i, u, a)), (e = !0));
            } else if (12 === c) {
              let t;
          ...
          13 === c && r.push(Pt._createLink(n, o, i, u, s));
        }
        return r;
      }
    }
    ...
    Rt.INSTANCE = new Rt();
    const Ft = Object.freeze(function (e, t) {
    ...
    class Kt {
      ...
      get onCancellationRequested() {
        return this._isCancelled
          ? Ft
          : (this._emitter || (this._emitter = new M()), this._emitter.event);
      }
      dispose() {
    ...
    class jt {
      ...
      cancel() {
        this._token
          ? this._token instanceof Kt && this._token.cancel()
      ...
      dispose(e = !1) {
        e && this.cancel(),
          ...
          this._token
            ? this._token instanceof Kt && this._token.dispose()
            : (this._token = Dt.None);
      }
    }
    class Ut {
    ...
    const $t = new Ut(),
      ...
      Xt = [],
      Zt = [];
    for (let _s = 0; _s <= 193; _s++) Xt[_s] = -1;
    for (let _s = 0; _s <= 126; _s++) Zt[_s] = -1;
    var Qt,
      Yt,
      en,
      tn,
    ...
    (function () {
      ...
      for (const i of t) {
        ...
        if (
          ...
          $t.define(a, u), Bt.define(a, h || u), qt.define(a, f || h || u);
        }
        l && (Wt[l] = a), c && (Ht[c] = a);
      }
      Zt[3] = 46;
      ...
      (function (e) {
        function t(e) {
          return $t.keyCodeToStr(e);
        }
        function n(e) {
          return $t.strToKeyCode(e);
        }
        function r(e) {
        ...
        function o(e) {
          return Bt.strToKeyCode(e) || qt.strToKeyCode(e);
        }
        function s(e) {
    ...
    class Rn extends rt {
      ...
      equalsSelection(e) {
        return Rn.selectionsEqual(this, e);
      }
      ...
      setEndPosition(e, t) {
        return 0 === this.getDirection()
          ? new Rn(this.startLineNumber, this.startColumn, e, t)
          : new Rn(e, t, this.startLineNumber, this.startColumn);
      }
      getPosition() {
      ...
      setStartPosition(e, t) {
        return 0 === this.getDirection()
          ? new Rn(e, t, this.endLineNumber, this.endColumn)
          : new Rn(this.endLineNumber, this.endColumn, e, t);
      }
      static fromPositions(e, t = e) {
        return new Rn(e.lineNumber, e.column, t.lineNumber, t.column);
      }
      ...
      static createWithDirection(e, t, n, r, i) {
        return 0 === i ? new Rn(e, t, n, r) : new Rn(n, r, e, t);
      }
    }
    class Fn {
      constructor(e, t, n) {
    ...
    (function (e) {
      ...
      (function (e) {
        (e[(e['acceptSuggestionOnCommitCharacter'] = 0)] =
          ...
          (e[(e['hideCursorInOverviewRuler'] = 51)] =
          ...
          (e[(e['definitionLinkOpensInPeek'] = 77)] =
    ...
    (Dn.CtrlCmd = 2048), (Dn.Shift = 1024), (Dn.Alt = 512), (Dn.WinCtrl = 256);
    ...
    class Un extends bt {
      ...
      getWordAtPosition(e, t) {
        let n = Et(e.column, wt(t), this._lines[e.lineNumber - 1], 0);
        return n
          ? new rt(e.lineNumber, n.startColumn, e.lineNumber, n.endColumn)
          : null;
      }
      words(e) {
        const t = this._lines,
      ...
      getValueInRange(e) {
        if (
          ((e = this._validateRange(e)), e.startLineNumber === e.endLineNumber)
        )
      ...
      computeMoreMinimalEdits(e, t) {
        return jn(this, void 0, void 0, function* () {
          ...
          t = t.slice(0).sort((e, t) => {
            if (e.range && t.range)
              return rt.compareRangesUsingStarts(e.range, t.range);
            let n = e.range ? 0 : 1,
              r = t.range ? 0 : 1;
            return n - r;
          });
          for (let { range: e, text: o, eol: s } of t) {
            if (('number' === typeof s && (i = s), rt.isEmpty(e) && !o))
              continue;
            const t = n.getValueInRange(e);
            if (((o = o.replace(/\r\n|\n|\r/g, n.eol)), t === o)) continue;
            if (Math.max(o.length, t.length) > $n._diffLimit) {
              r.push({ range: e, text: o });
              continue;
            }
            const a = fe(t, o, !1),
              u = n.offsetAt(rt.lift(e).getStartPosition());
            for (const e of a) {
            ...
            if (e)
              for (let n of e.words(o))
                if (
                  n !== t &&
                  isNaN(Number(n)) &&
                  (s.add(n), s.size > $n._suggestionsLimit)
                )
                  break e;
          }
      ...
      navigateValueSet(e, t, n, r, i) {
        return jn(this, void 0, void 0, function* () {
          ...
          let l = o.getValueInRange(u),
            c = Rt.INSTANCE.navigateValueSet(t, a, u, l, n);
          return c;
        });
      }
    ...
    ($n._diffLimit = 1e5),
      ...
      'function' === typeof importScripts && (N['a'].monaco = Kn());
    let Bn = !1;
    function qn(e) {
      if (Bn) return;
      Bn = !0;
    ...
    function Wn(e, t) {
      ...
      function m() {
        ...
        if (48 === e.charCodeAt(r)) r++;
          ...
          r++;
          while (r < e.length && Gn(e.charCodeAt(r))) r++;
        }
        if (r < e.length && 46 === e.charCodeAt(r)) {
          if ((r++, !(r < e.length && Gn(e.charCodeAt(r)))))
          ...
          case 47:
            ...
            if (42 === e.charCodeAt(r + 1)) {
              ...
              while (r < d) {
                ...
                r++,
                  zn(y) &&
                    (13 === y && 10 === e.charCodeAt(r) && r++, a++, (l = r));
              }
    ...
    function Jn(e, t, n) {
      ...
      if (t) {
        ...
        while (o > 0 && !Yn(e, o - 1)) o--;
        var u = a;
        while (u < e.length && !Yn(e, u)) u++;
        (i = e.substring(o, u)), (r = Zn(i, n));
    ...
    var er;
    function tr(e, t, n) {
      void 0 === t && (t = []), void 0 === n && (n = er.DEFAULT);
      var r = null,
        i = [],
        o = [];
      function s(e) {
    ...
    function Kr(e, t) {
      ...
      if (Array.isArray(e)) {
        if (e.length !== t.length) return !1;
        for (n = 0; n < e.length; n++) if (!Kr(e[n], t[n])) return !1;
      } else {
        var i = [];
        for (r in e) i.push(r);
        i.sort();
        var o = [];
        for (r in t) o.push(r);
        if ((o.sort(), !Kr(i, o))) return !1;
        for (n = 0; n < i.length; n++) if (!Kr(e[i[n]], t[i[n]])) return !1;
      }
      return !0;
    }
    function jr(e) {
    ...
    (function (e) {
      ...
      (function (e) {
        function t(e, t) {
          return (
            e === Number.MAX_VALUE && (e = ur.MAX_VALUE),
      ...
      (function (e) {
        function t(e, t, n, r) {
          if (
            ...
            return { start: lr.create(e, t), end: lr.create(n, r) };
          if (lr.is(e) && lr.is(t)) return { start: e, end: t };
          throw new Error(
        ...
        function n(e) {
          var t = e;
          return Ni.objectLiteral(t) && lr.is(t.start) && lr.is(t.end);
        }
        (e.create = t), (e.is = n);
      })(cr || (cr = {})),
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            Ni.defined(t) &&
            cr.is(t.range) &&
            (Ni.string(t.uri) || Ni.undefined(t.uri))
          );
        }
        (e.create = t), (e.is = n);
      })(hr || (hr = {})),
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            Ni.defined(t) &&
            cr.is(t.targetRange) &&
            Ni.string(t.targetUri) &&
            (cr.is(t.targetSelectionRange) ||
              Ni.undefined(t.targetSelectionRange)) &&
            (cr.is(t.originSelectionRange) ||
              Ni.undefined(t.originSelectionRange))
          );
        }
        (e.create = t), (e.is = n);
      })(fr || (fr = {})),
      (function (e) {
        ...
        function n(e) {
          var t = e;
          return (
            Ni.numberRange(t.red, 0, 1) &&
            Ni.numberRange(t.green, 0, 1) &&
            Ni.numberRange(t.blue, 0, 1) &&
            Ni.numberRange(t.alpha, 0, 1)
          );
        }
        (e.create = t), (e.is = n);
      })(dr || (dr = {})),
      (function (e) {
        ...
        function n(e) {
          var t = e;
          return cr.is(t.range) && dr.is(t.color);
        }
        (e.create = t), (e.is = n);
      })(mr || (mr = {})),
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            Ni.string(t.label) &&
            (Ni.undefined(t.textEdit) || Ar.is(t)) &&
            (Ni.undefined(t.additionalTextEdits) ||
              Ni.typedArray(t.additionalTextEdits, Ar.is))
          );
        }
        (e.create = t), (e.is = n);
      })(gr || (gr = {})),
      ...
      (function (e) {
        function t(e, t, n, r, i) {
          ...
          return (
            Ni.defined(n) && (o.startCharacter = n),
            Ni.defined(r) && (o.endCharacter = r),
            Ni.defined(i) && (o.kind = i),
            o
          );
        }
        function n(e) {
          var t = e;
          return (
            Ni.uinteger(t.startLine) &&
            Ni.uinteger(t.startLine) &&
            (Ni.undefined(t.startCharacter) || Ni.uinteger(t.startCharacter)) &&
            (Ni.undefined(t.endCharacter) || Ni.uinteger(t.endCharacter)) &&
            (Ni.undefined(t.kind) || Ni.string(t.kind))
          );
        }
        (e.create = t), (e.is = n);
      })(vr || (vr = {})),
      (function (e) {
        ...
        function n(e) {
          var t = e;
          return Ni.defined(t) && hr.is(t.location) && Ni.string(t.message);
        }
        (e.create = t), (e.is = n);
      })(yr || (yr = {})),
      (function (e) {
      ...
      (function (e) {
        function t(e) {
          var t = e;
          return void 0 !== t && null !== t && Ni.string(t.href);
        }
        e.is = t;
      })(Cr || (Cr = {})),
      (function (e) {
        function t(e, t, n, r, i, o) {
          ...
          return (
            Ni.defined(n) && (s.severity = n),
            Ni.defined(r) && (s.code = r),
            Ni.defined(i) && (s.source = i),
            Ni.defined(o) && (s.relatedInformation = o),
            s
          );
        }
        function n(e) {
          ...
          return (
            ...
            cr.is(n.range) &&
            Ni.string(n.message) &&
            (Ni.number(n.severity) || Ni.undefined(n.severity)) &&
            (Ni.integer(n.code) || Ni.string(n.code) || Ni.undefined(n.code)) &&
            (Ni.undefined(n.codeDescription) ||
              Ni.string(
                null === (t = n.codeDescription) || void 0 === t
                  ? void 0
                  : t.href,
              )) &&
            (Ni.string(n.source) || Ni.undefined(n.source)) &&
            (Ni.undefined(n.relatedInformation) ||
              Ni.typedArray(n.relatedInformation, yr.is))
          );
        }
        (e.create = t), (e.is = n);
      })(Sr || (Sr = {})),
      (function (e) {
        function t(e, t) {
          ...
          return Ni.defined(n) && n.length > 0 && (i.arguments = n), i;
        }
        function n(e) {
          var t = e;
          return Ni.defined(t) && Ni.string(t.title) && Ni.string(t.command);
        }
        (e.create = t), (e.is = n);
      })(wr || (wr = {})),
      (function (e) {
        ...
        function i(e) {
          var t = e;
          return Ni.objectLiteral(t) && Ni.string(t.newText) && cr.is(t.range);
        }
      ...
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            ...
            Ni.objectLiteral(t) &&
            Ni.string(t.label) &&
            (Ni.boolean(t.needsConfirmation) ||
              void 0 === t.needsConfirmation) &&
            (Ni.string(t.description) || void 0 === t.description)
          );
        }
        (e.create = t), (e.is = n);
      })(Er || (Er = {})),
      ...
      (function (e) {
        ...
        function i(e) {
          var t = e;
          return Ar.is(t) && (Er.is(t.annotationId) || Nr.is(t.annotationId));
        }
        (e.replace = t), (e.insert = n), (e.del = r), (e.is = i);
      })(xr || (xr = {})),
      (function (e) {
        ...
        function n(e) {
          var t = e;
          return (
            Ni.defined(t) && Jr.is(t.textDocument) && Array.isArray(t.edits)
          );
        }
        (e.create = t), (e.is = n);
      })(Lr || (Lr = {})),
          ...
          return (
            ...
            (void 0 === t.options ||
              ((void 0 === t.options.overwrite ||
                Ni.boolean(t.options.overwrite)) &&
                (void 0 === t.options.ignoreIfExists ||
                  Ni.boolean(t.options.ignoreIfExists)))) &&
            (void 0 === t.annotationId || Nr.is(t.annotationId))
          );
        }
        (e.create = t), (e.is = n);
      })(kr || (kr = {})),
          ...
          return (
            ...
            (void 0 === t.options ||
              ((void 0 === t.options.recursive ||
                Ni.boolean(t.options.recursive)) &&
                (void 0 === t.options.ignoreIfNotExists ||
                  Ni.boolean(t.options.ignoreIfNotExists)))) &&
            (void 0 === t.annotationId || Nr.is(t.annotationId))
          );
        }
        (e.create = t), (e.is = n);
          ...
          return (
            ...
            (void 0 === t.documentChanges ||
              t.documentChanges.every(function (e) {
                return Ni.string(e.kind)
                  ? kr.is(e) || Tr.is(e) || Or.is(e)
                  : Lr.is(e);
              }))
          );
        }
      ...
      Object.defineProperty(e.prototype, 'edit', {
          ...
          if (Jr.is(e)) {
            ...
            if (!n) {
              ...
              this._workspaceEdit.documentChanges.push(i),
                (n = new wi(r, this._changeAnnotations)),
        ...
        (e.prototype.initDocumentChanges = function () {
          void 0 === this._workspaceEdit.documentChanges &&
            ...
            ((this._changeAnnotations = new Ai()),
        ...
        (e.prototype.createFile = function (e, t, n) {
          ...
          var r, i, o;
          if (
            (Er.is(t) || Nr.is(t) ? (r = t) : (n = t),
            void 0 === r
              ? (i = kr.create(e, n))
              : ((o = Nr.is(r) ? r : this._changeAnnotations.manage(r)),
                (i = kr.create(e, n, o))),
            this._workspaceEdit.documentChanges.push(i),
            void 0 !== o)
          )
        ...
        (e.prototype.renameFile = function (e, t, n, r) {
          ...
          var i, o, s;
          if (
            (Er.is(n) || Nr.is(n) ? (i = n) : (r = n),
            void 0 === i
              ? (o = Tr.create(e, t, r))
              : ((s = Nr.is(i) ? i : this._changeAnnotations.manage(i)),
                (o = Tr.create(e, t, r, s))),
    ...
    (function (e) {
      ...
      function n(e) {
        var t = e;
        return Ni.defined(t) && Ni.string(t.uri);
      }
      (e.create = t), (e.is = n);
    })(zr || (zr = {})),
      (function (e) {
        ...
        function n(e) {
          var t = e;
          return Ni.defined(t) && Ni.string(t.uri) && Ni.integer(t.version);
        }
        (e.create = t), (e.is = n);
      })(Gr || (Gr = {})),
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            Ni.defined(t) &&
            Ni.string(t.uri) &&
            (null === t.version || Ni.integer(t.version))
          );
        }
        (e.create = t), (e.is = n);
      })(Jr || (Jr = {})),
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            Ni.defined(t) &&
            Ni.string(t.uri) &&
            Ni.string(t.languageId) &&
            Ni.integer(t.version) &&
            Ni.string(t.text)
          );
        }
        (e.create = t), (e.is = n);
      ...
      (function (e) {
        function t(e) {
          var t = e;
          return Ni.objectLiteral(e) && Zr.is(t.kind) && Ni.string(t.value);
        }
        e.is = t;
      })(Qr || (Qr = {})),
      (function (e) {
      ...
      (function (e) {
        ...
        function n(e) {
          var t = e;
          return (
            t && Ni.string(t.newText) && cr.is(t.insert) && cr.is(t.replace)
          );
        }
        (e.create = t), (e.is = n);
      })(ni || (ni = {})),
      ...
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            Ni.string(t) ||
            (Ni.objectLiteral(t) && Ni.string(t.language) && Ni.string(t.value))
          );
        }
      ...
      (function (e) {
        function t(e) {
          ...
          return (
            ...
            (Qr.is(t.contents) ||
              si.is(t.contents) ||
              Ni.typedArray(t.contents, si.is)) &&
            (void 0 === e.range || cr.is(e.range))
          );
        }
        e.is = t;
      })(ai || (ai = {})),
      ...
      (function (e) {
        function t(e, t) {
          ...
          var i = { label: e };
          return (
            Ni.defined(t) && (i.documentation = t),
            Ni.defined(n) ? (i.parameters = n) : (i.parameters = []),
            i
          );
        }
        e.create = t;
      ...
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            ...
            Ni.number(t.kind) &&
            cr.is(t.range) &&
            cr.is(t.selectionRange) &&
            (void 0 === t.detail || Ni.string(t.detail)) &&
            (void 0 === t.deprecated || Ni.boolean(t.deprecated)) &&
      ...
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            Ni.defined(t) &&
            Ni.typedArray(t.diagnostics, Sr.is) &&
            (void 0 === t.only || Ni.typedArray(t.only, Ni.string))
          );
        }
        (e.create = t), (e.is = n);
      })(vi || (vi = {})),
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            t &&
            Ni.string(t.title) &&
            (void 0 === t.diagnostics || Ni.typedArray(t.diagnostics, Sr.is)) &&
            (void 0 === t.kind || Ni.string(t.kind)) &&
            (void 0 !== t.edit || void 0 !== t.command) &&
            (void 0 === t.command || wr.is(t.command)) &&
            (void 0 === t.isPreferred || Ni.boolean(t.isPreferred)) &&
            (void 0 === t.edit || Ir.is(t.edit))
          );
        }
        (e.create = t), (e.is = n);
      })(yi || (yi = {})),
      (function (e) {
        function t(e, t) {
          var n = { range: e };
          return Ni.defined(t) && (n.data = t), n;
        }
        function n(e) {
          var t = e;
          return (
            Ni.defined(t) &&
            cr.is(t.range) &&
            (Ni.undefined(t.command) || wr.is(t.command))
          );
        }
        (e.create = t), (e.is = n);
      })(bi || (bi = {})),
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            Ni.defined(t) &&
            Ni.uinteger(t.tabSize) &&
            Ni.boolean(t.insertSpaces)
          );
        }
        (e.create = t), (e.is = n);
      })(_i || (_i = {})),
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            Ni.defined(t) &&
            cr.is(t.range) &&
            (Ni.undefined(t.target) || Ni.string(t.target))
          );
        }
        (e.create = t), (e.is = n);
      })(Ci || (Ci = {})),
    ...
    (function (e) {
      ...
      function n(e) {
        ...
        return !!(
          Ni.defined(t) &&
          Ni.string(t.uri) &&
          (Ni.undefined(t.languageId) || Ni.string(t.languageId)) &&
          Ni.uinteger(t.lineCount) &&
          Ni.func(t.getText) &&
          Ni.func(t.positionAt) &&
          Ni.func(t.offsetAt)
        );
      }
      function r(e, t) {
        for (
          ...
          (n = n.substring(0, u) + a.newText + n.substring(l, n.length)),
            (o = u);
        }
        return n;
      }
        ...
        return (
          ...
          (e.prototype.positionAt = function (e) {
            ...
            var t = this.getLineOffsets(),
              n = 0,
              r = t.length;
            if (0 === r) return lr.create(0, e);
            while (n < r) {
              var i = Math.floor((n + r) / 2);
              t[i] > e ? (r = i) : (n = i + 1);
            }
            var o = n - 1;
            return lr.create(o, e - t[o]);
          }),
            ...
            for (var r = 0, i = t; r < i.length; r++) {
              ...
              if (e.isIncremental(o)) {
                ...
                if (c - l === f.length)
                  ...
                  f.length < 1e4
                    ? h.splice.apply(h, Oi([l + 1, c - l], f, !1))
                    : (this._lineOffsets = h =
          ...
          (e.prototype.getLineOffsets = function () {
            return (
              void 0 === this._lineOffsets &&
                (this._lineOffsets = Pi(this._content, !0)),
              this._lineOffsets
            );
          }),
          (e.prototype.positionAt = function (e) {
    ...
    (function (e) {
      ...
      function n(e, t, n) {
        if (e instanceof Ii) return e.update(t, n), e;
        throw new Error(
      ...
      (function (e) {
        e.LATEST = {
          textDocument: {
            completion: {
              completionItem: {
                documentationFormat: [Zr.Markdown, Zr.PlainText],
    ...
    var Yi = (function () {
        ...
        return (
          ...
          (e.prototype.include = function (e) {
            return (
              (-1 === this.focusOffset || oo(e, this.focusOffset)) &&
              e !== this.exclude
            );
          }),
    ...
    var so = (function () {
      ...
      return (
        (e.prototype.getNodeFromOffset = function (e, t) {
          if ((void 0 === t && (t = !1), this.root)) return Vr(this.root, e, t);
        }),
        ...
        (e.prototype.validate = function (e, t, n) {
          if ((void 0 === n && (n = br.Warning), this.root && t)) {
            var r = new to();
            return (
              ao(this.root, t, r, eo.instance),
        ...
        (e.prototype.getMatchingSchemas = function (e, t, n) {
          void 0 === t && (t = -1);
          var r = new Yi(t, n);
          return this.root && e && ao(this.root, e, new to(), r), r.schemas;
        }),
        e
      );
    })();
    function ao(e, t, n, r) {
        ...
        var m = function (e, t) {
          for (var o = [], s = void 0, a = 0, u = e; a < u.length; a++) {
            var l = u[a],
              ...
              h = new to(),
              f = r.newSub();
            if ((ao(i, c, h, f), h.hasProblems() || o.push(c), s))
        ...
        var g = function (e) {
          ...
          p = function (e, t, n) {
            var o = Qi(e),
              s = new to(),
              a = r.newSub();
            ao(i, o, s, a), r.merge(a), s.hasProblems() ? n && g(n) : t && g(t);
          },
          v = Qi(t.if);
        if ((v && p(v, Qi(t.then), Qi(t.else)), Array.isArray(t.enum))) {
          for (var y = ro(i), b = !1, _ = 0, C = t.enum; _ < C.length; _++) {
            var S = C[_];
            if (Kr(y, S)) {
              b = !0;
              break;
            ...
            case 'uri-reference':
              ...
              if (e.value) {
                ...
                s
                  ...
                  : (o = $i('uriMissing', 'URI is expected.'));
              } else o = $i('uriEmpty', 'URI expected.');
              o &&
                n.problems.push({
                  location: { offset: e.offset, length: e.length },
                  message:
                    t.patternErrorMessage ||
                    t.errorMessage ||
                    $i('uriFormatWarning', 'String is not a URI: {0}', o),
                });
              break;
            case 'color-hex':
            case 'date-time':
        ...
        if (Array.isArray(t.items)) {
          for (var i = t.items, o = 0; o < i.length; o++) {
            var s = i[o],
              ...
              l = e.items[o];
            l
              ? (ao(l, a, u, r), n.mergePropertyMatch(u))
          ...
          if (e.items.length > i.length)
            if ('object' === typeof t.additionalItems)
              for (var c = i.length; c < e.items.length; c++) {
                u = new to();
                ao(e.items[c], t.additionalItems, u, r),
          ...
          if (h)
            for (var f = 0, d = e.items; f < d.length; f++) {
              (l = d[f]), (u = new to());
              ao(l, h, u, r), n.mergePropertyMatch(u);
            }
        }
        var m = Qi(t.contains);
        if (m) {
          var g = e.items.some(function (e) {
            var t = new to();
            return ao(e, m, t, eo.instance), !t.hasProblems();
          });
          g ||
            n.problems.push({
              location: { offset: e.offset, length: e.length },
      ...
      function l(e, t, n, r) {
          ...
          for (var p = 0, v = Object.keys(t.properties); p < v.length; p++) {
            ...
            if (b)
              if ($r(y))
                ...
                var _ = new to();
                ao(b, y, _, r), n.mergePropertyMatch(_);
              }
          }
        if (t.patternProperties)
          for (
            var C = 0, S = Object.keys(t.patternProperties);
            C < S.length;
            C++
          )
            for (
              var w = S[C], A = Hr(w), E = 0, N = o.slice(0);
              E < N.length;
              E++
            ) {
              f = N[E];
        ...
        if ('object' === typeof t.additionalProperties)
          for (var x = 0, L = o; x < L.length; x++) {
            (f = L[x]), (b = i[f]);
            if (b) {
              _ = new to();
              ao(b, t.additionalProperties, _, r), n.mergePropertyMatch(_);
            }
          }
          ...
          for (var O = 0, I = Object.keys(t.dependencies); O < I.length; O++) {
            ...
            if (M) {
              ...
              if (Array.isArray(P))
                ...
                if (y) {
                  _ = new to();
                  ao(e, y, _, r), n.mergePropertyMatch(_);
                }
              }
            }
          }
        var D = Qi(t.propertyNames);
        if (D)
          for (var K = 0, j = e.properties; K < j.length; K++) {
            var U = j[K];
            l = U.keyNode;
            l && ao(l, D, n, eo.instance);
          }
      }
    }
    function uo(e, t) {
      ...
      function u(t, i, o, s, a) {
        if ((void 0 === a && (a = br.Error), 0 === n.length || o !== r)) {
          var u = cr.create(e.positionAt(o), e.positionAt(s));
          n.push(Sr.create(u, t, a, i, e.languageId)), (r = o);
        }
      }
      ...
      function f(e) {
        if (3 === o.getToken()) {
          var t = new zi(e, o.getTokenOffset());
          a();
          var n = !1;
          while (4 !== o.getToken() && 17 !== o.getToken()) {
            if (5 === o.getToken()) {
              n || l($i('ValueExpected', 'Value expected'), ki.ValueExpected);
              ...
              n && l($i('ExpectedComma', 'Expected comma'), ki.CommaExpected);
            var i = b(t);
            i
              ? t.items.push(i)
              : l(
          ...
          return 4 !== o.getToken()
            ? l(
                ...
                ki.CommaOrCloseBacketExpected,
                t,
              )
            : h(t, !0);
        }
      }
      var d = new Ji(void 0, 0, 0);
      function m(t, n) {
        var r = new Xi(t, o.getTokenOffset(), d),
          i = p(r);
        if (!i) {
          ...
          var s = new Ji(r, o.getTokenOffset(), o.getTokenLength());
        ...
        if (
          ...
          (l($i('ColonExpected', 'Colon expected'), ki.ColonExpected),
          10 === o.getToken() &&
        ...
        if (1 === o.getToken()) {
          ...
          while (2 !== o.getToken() && 17 !== o.getToken()) {
            if (5 === o.getToken()) {
              ...
              r && l($i('ExpectedComma', 'Expected comma'), ki.CommaExpected);
            var s = m(t, n);
            s
              ? t.properties.push(s)
              : l(
      ...
      function p(e) {
        if (10 === o.getToken()) {
          var t = new Ji(e, o.getTokenOffset());
          return (t.value = o.getTokenValue()), h(t, !0);
        }
      }
      function v(e) {
        if (11 === o.getToken()) {
          var t = new Gi(e, o.getTokenOffset());
      ...
      function y(e) {
        switch (o.getToken()) {
          case 7:
            return h(new Wi(e, o.getTokenOffset()), !0);
          case 8:
            return h(new Hi(e, !0, o.getTokenOffset()), !0);
          case 9:
            return h(new Hi(e, !1, o.getTokenOffset()), !0);
          default:
            return;
        }
      }
    ...
    function lo(e, t, n) {
      if (null !== e && 'object' === typeof e) {
        ...
        for (i = '{\n', o = 0; o < s.length; o++) {
          var a = s[o];
          (i += r + JSON.stringify(a) + ': ' + lo(e[a], r, n)),
            o < s.length - 1 && (i += ','),
            (i += '\n');
        }
        return (i += t + '}'), i;
      ...
      mo = (function () {
        ...
        return (
              ...
              m = {
                add: function (e) {
                  ...
                  if (n)
                    ...
                    l &&
                      void 0 !== e.insertText &&
                      (e.textEdit = Ar.replace(l, e.insertText)),
                      f &&
                        (e.commitCharacters = e.kind === Yr.Property ? fo : ho),
                      (e.label = t),
                      (d[t] = e),
                      i.items.push(e);
                  }
              ...
              .then(function (t) {
                ...
                if (a && 'string' === a.type) {
                  ...
                  p &&
                    ...
                    ((h = !p.valueNode),
                    (g = p),
                    (f = o.substr(a.offset + 1, a.length - 2)),
                    p && (a = p.parent));
                }
                if (a && 'object' === a.type) {
                  ...
                  v.forEach(function (e) {
                    (g && g === e) || (d[e.keyNode.value] = ii.create('__'));
                  });
                  var y = '';
                  h && (y = r.evaluateSeparatorAfter(e, e.offsetAt(l.end))),
                    t
                      ? r.getPropertyCompletions(t, n, a, h, y, m)
                      : r.getSchemaLessPropertyCompletions(n, a, f, m);
                  var b = io(a);
                ...
                return (
                  t
                    ? r.getValueCompletions(t, n, a, s, e, m, _)
                    : r.getSchemaLessValueCompletions(n, a, s, e, m),
                  r.contributions.length > 0 &&
                    r.getContributedValueCompletions(n, a, s, e, m, u),
          ...
          (e.prototype.addDefaultValueCompletions = function (e, t, n, r) {
            ...
            if (Ur(e.default)) {
              ...
              n.add({
                ...
                insertTextFormat: ei.Snippet,
                detail: co('json.suggest.default', 'Default value'),
              }),
                (o = !0);
            }
          ...
          (e.prototype.collectTypes = function (e, t) {
            if (!Array.isArray(e.enum) && !Ur(e.const)) {
              var n = e.type;
              Array.isArray(n)
          ...
          (e.prototype.addFillerValueCompletions = function (e, t, n) {
            e['object'] &&
              n.add({
                ...
                insertTextFormat: ei.Snippet,
                detail: co('defaults.object', 'New object'),
                documentation: '',
              }),
              e['array'] &&
                n.add({
                  ...
                  insertText: this.getInsertTextForGuessedValue([], t),
                  insertTextFormat: ei.Snippet,
                  detail: co('defaults.array', 'New array'),
                  documentation: '',
                });
          }),
            ...
            if (t) {
              if (Array.isArray(t.defaultSnippets)) {
                if (1 === t.defaultSnippets.length) {
                  ...
                  Ur(u) && (o = this.getInsertTextForSnippetValue(u, ''));
                }
          ...
          (e.prototype.findItemAtOffset = function (e, t, n) {
            for (
              var r = Mr(t.getText(), !0), i = e.items, o = i.length - 1;
              o >= 0;
              o--
            ) {
              var s = i[o];
          ...
          (e.prototype.fromMarkup = function (e) {
            if (e && this.doesSupportMarkdown())
              return { kind: Zr.Markdown, value: e };
          }),
          (e.prototype.doesSupportMarkdown = function () {
            if (!Ur(this.supportsMarkdown)) {
              var e =
              ...
              this.supportsMarkdown =
                ...
                -1 !==
                  e.completionItem.documentationFormat.indexOf(Zr.Markdown);
            }
            return this.supportsMarkdown;
          }),
          (e.prototype.doesSupportsCommitCharacters = function () {
            if (!Ur(this.supportsCommitCharacters)) {
              var e =
                this.clientCapabilities.textDocument &&
                this.clientCapabilities.textDocument.completion;
        ...
        function e(e, t) {
          ...
          try {
            for (var n = 0, r = e; n < r.length; n++) {
              ...
              o || (i = i.substring(1)),
                i.length > 0 &&
                  (i[0] === So && (i = i.substring(1)),
                  this.globWrappers.push({
                    regexp: bo('**/' + i, { extended: !0, globstar: !0 }),
                    include: o,
                  }));
            }
            this.uris = t;
      ...
      Ao = (function () {
        function e(e, t, n) {
          (this.service = e),
            ...
            (this.dependencies = {}),
            n &&
              (this.unresolvedSchema = this.service.promise.resolve(new Eo(n)));
        }
        return (
        ...
        return (
          ...
          (e.prototype.loadSchema = function (e) {
            if (!this.requestService) {
              ...
              return this.promise.resolve(new Eo({}, [t]));
            }
            ...
            var a = this.contextService,
              ...
              c = function (e, t, n, o, s) {
                ...
                return u.getUnresolvedSchema().then(function (r) {
                  ...
                  return (
                    l(e, r.schema, t, n), h(e, r.schema, t, u.dependencies)
                  );
                });
              },
              h = function (e, t, n, i) {
                  ...
                  d = function (e) {
                    ...
                    while (e.$ref) {
                      ...
                      if ((delete e.$ref, s[0].length > 0))
                        return void a.push(c(e, s[0], s[1], n, i));
          ...
          (e.prototype.getMatchingSchemas = function (e, t, n) {
            if (n) {
              var r =
                n.id || 'schemaservice://untitled/matchingSchemas/' + Lo++;
              return this.resolveSchemaContent(new Eo(n), r, {}).then(function (
                e,
              ) {
        ...
        return (
          (e.prototype.configure = function (e) {
            e &&
              ...
              (this.commentSeverity = e.allowComments ? void 0 : br.Error));
          }),
              ...
              u = function (r) {
                ...
                if (r) {
                  if (r.errors.length && t.root && c) {
                    ...
                    if (f && '$schema' === f.keyNode.value) {
                      ...
                      a(Sr.create(m, r.errors[0], c, ki.SchemaResolveError));
                    } else {
                      m = cr.create(
                  ...
                  Vo(r.schema) && (u = void 0), Ro(r.schema) && (s = void 0);
                }
                for (var p = 0, v = t.syntaxErrors; p < v.length; p++) {
                  var y = v[p];
                  if (y.code === ki.TrailingComma) {
                ...
                if ('number' === typeof u) {
                  ...
                  t.comments.forEach(function (e) {
                    a(Sr.create(e, b, u, ki.CommentNotPermitted));
                  });
                }
                return o;
              };
            if (r) {
              var l = r.id || 'schemaservice://untitled/' + Po++;
              return this.jsonSchemaService
                .resolveSchemaContent(new Eo(r), l, {})
                .then(function (e) {
                  return u(e);
                });
            }
    ...
    function Vo(e) {
      if (e && 'object' === typeof e) {
        if ($r(e.allowComments)) return e.allowComments;
        if (e.allOf)
    ...
    function Ro(e) {
      if (e && 'object' === typeof e) {
        if ($r(e.allowTrailingCommas)) return e.allowTrailingCommas;
        var t = e;
        if ($r(t['allowsTrailingCommas'])) return t['allowsTrailingCommas'];
        if (e.allOf)
    ...
    function Bo(e) {
      return e < Do
        ...
        : e <= Ko
        ? e - Do
        : (e < Uo && (e += Uo - jo), e >= Uo && e <= $o ? e - Uo + 10 : 0);
    }
    function qo(e) {
      if ('#' === e[0])
        switch (e.length) {
          case 4:
            return {
              red: (17 * Bo(e.charCodeAt(1))) / 255,
              green: (17 * Bo(e.charCodeAt(2))) / 255,
              blue: (17 * Bo(e.charCodeAt(3))) / 255,
              alpha: 1,
            };
          case 5:
            return {
              ...
              green: (17 * Bo(e.charCodeAt(2))) / 255,
              blue: (17 * Bo(e.charCodeAt(3))) / 255,
              alpha: (17 * Bo(e.charCodeAt(4))) / 255,
            };
          case 7:
            return {
              red: (16 * Bo(e.charCodeAt(1)) + Bo(e.charCodeAt(2))) / 255,
              green: (16 * Bo(e.charCodeAt(3)) + Bo(e.charCodeAt(4))) / 255,
              blue: (16 * Bo(e.charCodeAt(5)) + Bo(e.charCodeAt(6))) / 255,
              alpha: 1,
            };
          case 9:
            return {
              ...
              green: (16 * Bo(e.charCodeAt(3)) + Bo(e.charCodeAt(4))) / 255,
              blue: (16 * Bo(e.charCodeAt(5)) + Bo(e.charCodeAt(6))) / 255,
              alpha: (16 * Bo(e.charCodeAt(7)) + Bo(e.charCodeAt(8))) / 255,
            };
        }
    }
    var Wo = (function () {
      ...
      return (
        (e.prototype.findDocumentSymbols = function (e, t, n) {
          ...
          if (
            ('vscode://defaultsettings/keybindings.json' === s ||
              Wr(s.toLowerCase(), '/user/keybindings.json')) &&
            'array' === i.type
          ) {
        ...
        (e.prototype.getColorPresentations = function (e, t, n, r) {
          ...
          return (
            ...
            o.push({ label: i, textEdit: Ar.replace(r, JSON.stringify(i)) }),
            o
          );
        }),
        e
    ...
    var zo = Ki(),
      ...
      Jo = {
        id: zo('schema.json.id', 'A unique identifier for the schema.'),
        $schema: zo(
          'schema.json.$schema',
          'The schema to verify this document against.',
        ),
        title: zo('schema.json.title', 'A descriptive title of the element.'),
        description: zo(
        ...
        not: zo('schema.json.not', 'A schema which must not match.'),
        $id: zo('schema.json.$id', 'A unique identifier for the schema.'),
        $ref: zo(
          'schema.json.$ref',
    ...
    for (var Xo in Go.schemas) {
      var Zo = Go.schemas[Xo];
      for (var Qo in Zo.properties) {
        var Yo = Zo.properties[Qo];
        'boolean' === typeof Yo && (Yo = Zo.properties[Qo] = {});
        var es = Jo[Qo];
        es
          ? (Yo['description'] = es)
          : console.log(Qo + ": localize('schema.json." + Qo + '\', "")');
      }
    }
    function ts(e, t) {
      var n = [],
        ...
        switch (a) {
          ...
          case 13:
            ...
            1 === s.getTokenError() && l + 1 < e.lineCount
              ? s.setPosition(e.offsetAt(lr.create(l + 1, 0)))
              : l < d &&
                (u({ startLine: l, endLine: d, kind: pr.Comment }), (o = l));
            break;
          case 12:
            ...
            if (g) {
              ...
              if (g[1]) {
                c = { startLine: f, endLine: f, kind: pr.Region };
                i.push(c);
              } else {
                var p = i.length - 1;
                while (p >= 0 && i[p].kind !== pr.Region) p--;
                if (p >= 0) {
                  c = i[p];
                  (i.length = p),
                    f > c.startLine &&
    ...
    function ns(e, t, n) {
      function r(t) {
        ...
        for (var h = void 0, f = a.length - 1; f >= 0; f--)
          h = Si.create(a[f], h);
        return h || (h = Si.create(cr.create(t, t))), h;
      }
      function i(t, n) {
        return cr.create(e.positionAt(t), e.positionAt(n));
      }
      var o = Mr(e.getText(), !0);
      function s(e, t) {
        o.setPosition(e);
        var n = o.scan();
    ...
    function ls(e) {
      var t = e.promiseConstructor || Promise,
        n = new xo(e.schemaRequestService, e.workspaceContext, t);
      n.setSchemaContributions(Go);
      var r = new mo(n, e.contributions, t, e.clientCapabilities),
        i = new go(n, e.contributions, t),
        o = new Wo(n),
        s = new Mo(n, t);
      return {
        ...
        format: function (e, t, n) {
          ...
          return Dr(e.getText(), r, s).map(function (t) {
            return Ar.replace(
              cr.create(
                e.positionAt(t.offset),
                e.positionAt(t.offset + t.length),
    ...
    var ds = (function () {
        function e(e, t) {
          (this._ctx = e),
            ...
            (this._languageService = ls({
              ...
              schemaRequestService: t.enableSchemaRequest && cs,
            })),
        ...
        return (
          ...
          (e.prototype._getTextDocument = function (e) {
            for (
              ...
              var i = r[n];
              if (i.uri.toString() === e)
                return Li.create(e, this._languageId, i.version, i.getValue());
            }
            return null;
          }),
          e
      ...
      gs = '.'.charCodeAt(0);
    function ps(e) {
      return e.charCodeAt(0) === ms;
    }
    function vs(e, t) {
      if (ps(t)) {
        var n = yo['a'].parse(e),
          r = t.split('/');
        return n.with({ path: ys(r) }).toString();
      }
      return bs(e, t);
    }
    function ys(e) {
      for (var t = [], n = 0, r = e; n < r.length; n++) {
        var i = r[n];
        0 === i.length ||
          (1 === i.length && i.charCodeAt(0) === gs) ||
          (2 === i.length && i.charCodeAt(0) === gs && i.charCodeAt(1) === gs
            ? t.pop()
            : t.push(i));
      }
    ...
    function bs(e) {
      for (var t = [], n = 1; n < arguments.length; n++)
        t[n - 1] = arguments[n];
      for (
        var r = yo['a'].parse(e), i = r.path.split('/'), o = 0, s = t;
        o < s.length;
        o++
      ) {
        var a = s[o];
      ...
      return r.with({ path: ys(i) }).toString();
    }
  ...
  MNsG: function (e, t, n) {
    ...
    (function (e, r) {
      ...
      let y;
      'undefined' !== typeof v.vscode && 'undefined' !== typeof v.vscode.process
        ? (y = v.vscode.process)
        : 'undefined' !== typeof r && (y = r);
      const b =
        'string' ===
          typeof (null ===
            (i = null === y || void 0 === y ? void 0 : y.versions) ||
          void 0 === i
            ? void 0
      ...
      if ('object' !== typeof navigator || b)
        if ('object' === typeof y) {
          (l = 'win32' === y.platform),
            (c = 'darwin' === y.platform),
            (h = 'linux' === y.platform),
            (f = h && !!y.env['SNAP'] && !!y.env['SNAP_REVISION']),
            (s = o),
            (p = o);
          ...
          if (e)
            try {
              ...
              (s = t.locale), (p = n || o), (a = t._translationsConfigFile);
            } catch (E) {}
          d = !0;
      ...
      const C = l,
        ...
        A = (function () {
          ...
          if (
            'function' ===
            typeof (null === y || void 0 === y ? void 0 : y.nextTick)
          )
              ...
              447: (t, n, r) => {
                ...
                !(function (e) {
                  (e.joinPath = function (e) {
                    for (var t = [], n = 1; n < arguments.length; n++)
                      t[n - 1] = arguments[n];
                    return e.with({ path: k.join.apply(k, L([e.path], t)) });
                  }),
                    (e.resolvePath = function (e) {
                      for (var t = [], n = 1; n < arguments.length; n++)
                        t[n - 1] = arguments[n];
                      var r = e.path || '/';
                      return e.with({ path: k.resolve.apply(k, L([r], t)) });
                    }),
