(function (e) {
  ...
  '5QBA': function (e, t, n) {
    ...
    (function (e) {
      ...
      function _(t, n = Number.POSITIVE_INFINITY) {
        const i = [];
        if (0 === n) return [i, t];
    ...
    function m(e) {
      return null === d || void 0 === d || d.trackDisposable(e), e;
    }
    function g(e) {
      null === d || void 0 === d || d.markAsDisposed(e);
    }
    function _(e, t) {
      null === d || void 0 === d || d.setParent(e, t);
    }
    function p(e, t) {
      if (d) for (const n of e) d.setParent(n, t);
    }
    ...
    class y {
      constructor() {
        (this._store = new N()), m(this), _(this._store, this);
      }
      dispose() {
    ...
    class w {
      ...
      _remove(e) {
        if (e.prev !== E.Undefined && e.next !== E.Undefined) {
          ...
          e.prev === E.Undefined && e.next === E.Undefined
            ? ((this._first = E.Undefined), (this._last = E.Undefined))
            : e.next === E.Undefined
            ? ((this._last = this._last.prev), (this._last.next = E.Undefined))
            : e.prev === E.Undefined &&
              ((this._first = this._first.next),
              (this._first.prev = E.Undefined));
        this._size -= 1;
      }
      *[Symbol.iterator]() {
        let e = this._first;
        while (e !== E.Undefined) yield e.element, (e = e.next);
      }
    }
    var A = n('MNsG');
    const v =
      A['a'].performance && 'function' === typeof A['a'].performance.now;
    class M {
      constructor(e) {
        (this._highResolution = v && e),
      ...
      _now() {
        return this._highResolution ? A['a'].performance.now() : Date.now();
      }
    }
    var O;
    (function (e) {
      ...
      function o(...e) {
        return (t, n = null, i) =>
          S(...e.map((e) => e((e) => t.call(n, e), null, i)));
      }
      function a(e, t, i) {
        let r = i;
      ...
      class f {
        ...
        map(e) {
          return new f(n(this.event, e));
        }
        forEach(e) {
          return new f(i(this.event, e));
        }
        filter(e) {
          return new f(r(this.event, e));
        }
        reduce(e, t) {
          return new f(a(this.event, e, t));
        }
        latch() {
          return new f(h(this.event));
        }
        debounce(e, t = 100, n = !1, i) {
          return new f(u(this.event, e, t, n, i));
        }
        on(e, t, n) {
      ...
      function g(e, t, n = (e) => e) {
        const i = (...e) => o.fire(n(...e)),
          r = () => e.on(t, i),
          s = () => e.removeListener(t, i),
          o = new V({ onFirstListenerAdd: r, onLastListenerRemove: s });
        return o.event;
      }
      function _(e, t, n = (e) => e) {
        const i = (...e) => o.fire(n(...e)),
          r = () => e.addEventListener(t, i),
          s = () => e.removeEventListener(t, i),
          o = new V({ onFirstListenerAdd: r, onLastListenerRemove: s });
        return o.event;
      }
      function p(e) {
    ...
    class K {
      constructor(e) {
        (this._listenerCount = 0),
          ...
          (this._name = `${e}_${K._idPool++}`);
      }
      start(e) {
        (this._stopWatch = new M(!0)), (this._listenerCount = e);
      }
      stop() {
        if (this._stopWatch) {
    ...
    class V {
      constructor(e) {
        ...
        (this._disposed = !1),
          ...
          (this._leakageMon =
            T > 0
              ? new R(this._options && this._options.leakWarningThreshold)
              : void 0),
          (this._perfMon = (
            null === (t = this._options) || void 0 === t ? void 0 : t._profName
          )
            ? new K(this._options._profName)
            : void 0);
      }
      get event() {
        return (
          this._event ||
            (this._event = (e, t, n) => {
              var i;
              this._listeners || (this._listeners = new w());
              ...
              return (
                n instanceof N ? n.add(a) : Array.isArray(n) && n.push(a), a
              );
            }),
          this._event
        );
    ...
    function P(e) {
      const t = [];
      for (const n of k(e)) 'function' === typeof e[n] && t.push(n);
      return t;
    }
    function I(e, t) {
      const n = (e) =>
    ...
    class J {
      ...
      sendMessage(e, t) {
        ...
        return new Promise((i, r) => {
          (this._pendingReplies[n] = { resolve: i, reject: r }),
            this._send(new G(this._workerId, n, e, t));
        });
      }
      listen(e, t) {
        let n = null;
        const i = new V({
          onFirstListenerAdd: () => {
            (n = String(++this._lastSentReq)),
              ...
              this._send(new Q(this._workerId, n, e, t));
          },
          onLastListenerRemove: () => {
            this._pendingEmitters.delete(n),
              this._send(new X(this._workerId, n)),
              (n = null);
          },
        });
        return i.event;
      ...
      _handleRequestMessage(e) {
        ...
        n.then(
          (e) => {
            this._send(new z(this._workerId, t, e, void 0));
          },
          (e) => {
            e.detail instanceof Error && (e.detail = o(e.detail)),
              this._send(new z(this._workerId, t, void 0, o(e)));
          },
        );
      }
      _handleSubscribeEventMessage(e) {
        const t = e.req,
          n = this._handler.handleEvent(
            ...
            this._send(new Y(this._workerId, t, e));
          });
    ...
    function Z(e) {
      return 'o' === e[0] && 'n' === e[1] && U(e.charCodeAt(2));
    }
    function ee(e) {
      return /^onDynamic/.test(e) && U(e.charCodeAt(9));
    }
    function te(e, t, n) {
      const i = (e) =>
          function () {
      ...
      let s = {};
      for (const o of e)
        ee(o) ? (s[o] = r(o)) : Z(o) ? (s[o] = n(o, void 0)) : (s[o] = i(o));
      return s;
    }
    class ne {
      constructor(e, t) {
    ...
    function se(e, t) {
      t = re(149417, t);
      for (let n = 0, i = e.length; n < i; n++) t = re(e.charCodeAt(n), t);
      return t;
    }
    function oe(e, t, n = 32) {
      const i = n - t,
        r = ~((1 << i) - 1);
      return ((e << t) | ((r & e) >>> i)) >>> 0;
    }
    function ae(e, t = 0, n = e.byteLength, i = 0) {
      ...
      _step() {
        ...
        for (let h = 0; h < 80; h++)
          h < 20
            ...
            (r = (oe(s, 5) + n + u + i + e.getUint32(4 * h, !1)) & 4294967295),
            (u = l),
            (l = a),
            (a = oe(o, 30)),
            (o = s),
    ...
    function de(e, t, n) {
      return new _e(new ce(e), new ce(t)).ComputeDiff(n).changes;
    }
    class fe {
      static Assert(e, t) {
    ...
    class _e {
      constructor(e, t, n = null) {
        ...
        const [i, r, s] = _e._getElements(e),
          [o, a, l] = _e._getElements(t);
      ...
      static _getElements(e) {
        ...
        if (_e._isStringArray(t)) {
          const e = new Int32Array(t.length);
          for (let n = 0, i = t.length; n < i; n++) e[n] = se(t[n], 0);
          return [t, e, !0];
        }
      ...
      ElementsAreStrictEqual(e, t) {
        ...
        const n = _e._getStrictElement(this._originalSequence, e),
          i = _e._getStrictElement(this._modifiedSequence, t);
        return n === i;
      }
      ...
      ComputeRecursionPoint(e, t, n, i, r, s, o) {
        ...
        const f = t - e + (i - n),
          ...
          N = L % 2 === 0;
        (g[p] = e), (_[C] = t), (o[0] = !1);
        for (let y = 1; y <= f / 2 + 1; y++) {
          let f = 0,
            L = 0;
          (u = this.ClipDiagonalBound(p - y, y, p, m)),
            (h = this.ClipDiagonalBound(p + y, y, p, m));
          for (let e = u; e <= h; e += 2) {
            (a =
              e === u || (e < h && g[e - 1] < g[e + 1])
                ? g[e + 1]
              ...
              (l = a - (e - p) - b);
            const n = a;
            while (a < t && l < i && this.ElementsAreEqual(a + 1, l + 1))
              a++, l++;
            if (
              ((g[e] = a),
              a + l > f + L && ((f = a), (L = l)),
              !N && Math.abs(e - C) <= y - 1 && a >= _[e])
            )
              return (
                (r[0] = a),
                (s[0] = l),
          ...
          if (
            ...
            return (
              ...
              E > 0 && y <= 1448
                ...
                : (e++, n++, [new ie(e, t - e + 1, n, i - n + 1)])
            );
          (c = this.ClipDiagonalBound(C - y, y, C, m)),
            (d = this.ClipDiagonalBound(C + y, y, C, m));
          for (let m = c; m <= d; m += 2) {
            (a =
              m === c || (m < d && _[m - 1] >= _[m + 1])
                ? _[m + 1] - 1
            ...
            if (((_[m] = a), N && Math.abs(m - p) <= y && a <= g[m]))
              return (
                (r[0] = a),
                (s[0] = l),
                f >= g[m] && y <= 1448
      ...
      _boundaryScore(e, t, n, i) {
        const r = this._OriginalRegionIsBoundary(e, t) ? 1 : 0,
          s = this._ModifiedRegionIsBoundary(n, i) ? 1 : 0;
        return r + s;
      }
      ConcatenateChanges(e, t) {
        ...
        if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
          ...
          return (
            me.Copy(e, 0, i, 0, e.length - 1),
            (i[e.length - 1] = n[0]),
            me.Copy(t, 1, i, e.length, t.length - 1),
            i
          );
        }
        {
    ...
    function Me(e, t) {
      if ('string' !== typeof e) throw new ve(t, 'string', e);
    }
    function Oe(e) {
      return e === ye || e === Ee;
    }
        ...
        if (i(l)) {
          if (o === u - 1 || 1 === a);
            ...
            if (
              r.length < 2 ||
              2 !== s ||
              r.charCodeAt(r.length - 1) !== Ne ||
              r.charCodeAt(r.length - 2) !== Ne
            ) {
              if (r.length > 2) {
    ...
    function Ve(e, t) {
      if (null === t || 'object' !== typeof t)
        throw new ve('pathObject', 'Object', t);
    ...
    const ke = {
        resolve(...e) {
          ...
          for (let r = e.length - 1; r >= -1; r--) {
            let s;
            if (r >= 0) {
              if (((s = e[r]), Me(s, 'path'), 0 === s.length)) continue;
            } else
              0 === t.length
                ? (s = pe['a']())
                : ((s = pe['b'][`=${t}`] || pe['a']()),
        ...
        normalize(e) {
          ...
          if (1 === t) return Ke(s) ? '\\' : e;
          if (Oe(s))
            if (((r = !0), Oe(e.charCodeAt(1)))) {
              let r = 2,
                s = r;
              while (r < t && !Oe(e.charCodeAt(r))) r++;
              if (r < t && r !== s) {
                const o = e.slice(s, r);
                s = r;
                while (r < t && Oe(e.charCodeAt(r))) r++;
        ...
        isAbsolute(e) {
          ...
          return (
            Oe(n) ||
            (t > 2 && Te(n) && e.charCodeAt(1) === we && Oe(e.charCodeAt(2)))
          );
        },
        join(...e) {
          ...
          if (i) {
            while (r < t.length && Oe(t.charCodeAt(r))) r++;
            r >= 2 && (t = `\\${t.slice(r)}`);
          }
          return ke.normalize(t);
        },
        relative(e, t) {
          if ((Me(e, 'from'), Me(t, 'to'), e === t)) return '';
          const n = ke.resolve(e),
            i = ke.resolve(t);
          if (n === i) return '';
          if (((e = n.toLowerCase()), (t = i.toLowerCase()), e === t))
            return '';
          let r = 0;
          while (r < e.length && e.charCodeAt(r) === Ee) r++;
          let s = e.length;
          while (s - 1 > r && e.charCodeAt(s - 1) === Ee) s--;
          const o = s - r;
          let a = 0;
          while (a < t.length && t.charCodeAt(a) === Ee) a++;
          let l = t.length;
          while (l - 1 > a && t.charCodeAt(l - 1) === Ee) l--;
          const u = l - a,
            h = o < u ? o : u;
          let c = -1,
            d = 0;
          ...
          if (d !== h) {
            ...
            if (u > h) {
              if (t.charCodeAt(a + d) === Ee) return i.slice(a + d + 1);
              if (2 === d) return i.slice(a + d);
            }
            o > h &&
              (e.charCodeAt(r + d) === Ee ? (c = d) : 2 === d && (c = 3)),
              -1 === c && (c = 0);
          }
          let f = '';
          for (d = r + c + 1; d <= s; ++d)
            (d !== s && e.charCodeAt(d) !== Ee) ||
              (f += 0 === f.length ? '..' : '\\..');
          return (
            (a += c),
            f.length > 0
              ? `${f}${i.slice(a, l)}`
              : (i.charCodeAt(a) === Ee && ++a, i.slice(a, l))
          );
        },
        toNamespacedPath(e) {
          if ('string' !== typeof e) return e;
          if (0 === e.length) return '';
          const t = ke.resolve(e);
          if (t.length <= 2) return e;
          if (t.charCodeAt(0) === Ee) {
            if (t.charCodeAt(1) === Ee) {
              const e = t.charCodeAt(2);
              if (e !== Ae && e !== Ne) return `\\\\?\\UNC\\${t.slice(2)}`;
            }
          } else if (
            Te(t.charCodeAt(0)) &&
            t.charCodeAt(1) === we &&
        ...
        parse(e) {
          ...
          } else if (Te(r) && e.charCodeAt(1) === we) {
      ...
      Pe = {
        resolve(...e) {
          ...
          for (let i = e.length - 1; i >= -1 && !n; i--) {
            const r = i >= 0 ? e[i] : pe['a']();
            Me(r, 'path'),
              0 !== r.length &&
                ((t = `${r}/${t}`), (n = r.charCodeAt(0) === ye));
          }
          return (t = Re(t, !n, '/', Ke)), n ? `/${t}` : t.length > 0 ? t : '.';
        },
        normalize(e) {
          if ((Me(e, 'path'), 0 === e.length)) return '.';
          const t = e.charCodeAt(0) === ye,
            n = e.charCodeAt(e.length - 1) === ye;
          return (
            (e = Re(e, !t, '/', Ke)),
            0 === e.length
              ? t
        ...
        isAbsolute(e) {
          return Me(e, 'path'), e.length > 0 && e.charCodeAt(0) === ye;
        },
        join(...e) {
          if (0 === e.length) return '.';
          let t;
          ...
          return void 0 === t ? '.' : Pe.normalize(t);
        },
        relative(e, t) {
          if ((Me(e, 'from'), Me(t, 'to'), e === t)) return '';
          if (((e = Pe.resolve(e)), (t = Pe.resolve(t)), e === t)) return '';
          const n = 1,
            i = e.length,
            r = i - n,
            s = 1,
          ...
          let l = -1,
            u = 0;
          for (; u < a; u++) {
            const i = e.charCodeAt(n + u);
            if (i !== t.charCodeAt(s + u)) break;
            i === ye && (l = u);
          }
          if (u === a)
            if (o > a) {
              if (t.charCodeAt(s + u) === ye) return t.slice(s + u + 1);
              if (0 === u) return t.slice(s + u);
            } else
              r > a &&
                (e.charCodeAt(n + u) === ye ? (l = u) : 0 === u && (l = 0));
          let h = '';
          for (u = n + l + 1; u <= i; ++u)
            (u !== i && e.charCodeAt(u) !== ye) ||
              (h += 0 === h.length ? '..' : '/..');
    ...
    (Pe.win32 = ke.win32 = ke), (Pe.posix = ke.posix = Pe);
    'win32' === pe['c'] ? ke.normalize : Pe.normalize,
      'win32' === pe['c'] ? ke.resolve : Pe.resolve,
      'win32' === pe['c'] ? ke.relative : Pe.relative,
      'win32' === pe['c'] ? ke.dirname : Pe.dirname,
      'win32' === pe['c'] ? ke.basename : Pe.basename,
      'win32' === pe['c'] ? ke.extname : Pe.extname,
      'win32' === pe['c'] ? ke.sep : Pe.sep;
    const Ie = /^\w[\w\d+.-]*$/,
      xe = /^\//,
      De = /^\/\//;
    function Fe(e, t) {
    ...
    class $e {
      constructor(e, t, n, i, r, s = !1) {
        'object' === typeof e
          ? ((this.scheme = e.scheme || qe),
            (this.authority = e.authority || qe),
            (this.path = e.path || qe),
            (this.query = e.query || qe),
            (this.fragment = e.fragment || qe))
          : ((this.scheme = Ue(e, s)),
            (this.authority = t || qe),
            (this.path = Be(this.scheme, n || qe)),
            (this.query = i || qe),
            (this.fragment = r || qe),
            Fe(this, s));
      }
      ...
      with(e) {
        ...
        return (
          void 0 === t ? (t = this.scheme) : null === t && (t = qe),
          void 0 === n ? (n = this.authority) : null === n && (n = qe),
          void 0 === i ? (i = this.path) : null === i && (i = qe),
          void 0 === r ? (r = this.query) : null === r && (r = qe),
          void 0 === s ? (s = this.fragment) : null === s && (s = qe),
          t === this.scheme &&
          n === this.authority &&
          i === this.path &&
          r === this.query &&
      ...
      static parse(e, t = !1) {
        ...
        return n
          ...
          : new Ge(qe, qe, qe, qe, qe);
      }
      static file(e) {
        let t = qe;
        if (
          (A['d'] && (e = e.replace(/\\/g, He)), e[0] === He && e[1] === He)
        ) {
          const n = e.indexOf(He, 2);
          -1 === n
            ? ((t = e.substring(2)), (e = He))
            : ((t = e.substring(2, n)), (e = e.substring(n) || He));
        }
        return new Ge('file', t, e, qe, qe);
      }
      static from(e) {
        const t = new Ge(e.scheme, e.authority, e.path, e.query, e.fragment);
        return Fe(t, !0), t;
      }
      static joinPath(e, ...t) {
        if (!e.path)
        ...
        if (e) {
          if (e instanceof $e) return e;
          {
            ...
            return (
              ...
              (t._fsPath = e._sep === je ? e.fsPath : null),
              t
            );
          }
        }
    ...
    function Ye(e) {
      ...
      for (let n = 0; n < e.length; n++) {
        ...
        35 === i || 63 === i
          ? (void 0 === t && (t = e.substr(0, n)), (t += ze[i]))
          : void 0 !== t && (t += e[n]);
      }
      return void 0 !== t ? t : e;
    }
    ...
    function tt(e) {
      return e.match(et) ? e.replace(et, (e) => Ze(e)) : e;
    }
    class nt {
      constructor(e, t) {
    ...
    class it {
      ...
      containsPosition(e) {
        return it.containsPosition(this, e);
      }
      ...
      containsRange(e) {
        return it.containsRange(this, e);
      }
      ...
      strictContainsRange(e) {
        return it.strictContainsRange(this, e);
      }
      ...
      intersectRanges(e) {
        return it.intersectRanges(this, e);
      }
      static intersectRanges(e, t) {
        ...
        return (
          ...
          n > r || (n === r && i > s) ? null : new it(n, i, r, s)
        );
      }
      equalsRange(e) {
        return it.equalsRange(this, e);
      }
      ...
      setEndPosition(e, t) {
        return new it(this.startLineNumber, this.startColumn, e, t);
      }
      setStartPosition(e, t) {
        return new it(e, t, this.endLineNumber, this.endColumn);
      }
      collapseToStart() {
        return it.collapseToStart(this);
      }
      ...
      static fromPositions(e, t = e) {
        return new it(e.lineNumber, e.column, t.lineNumber, t.column);
      }
      static lift(e) {
        return e
          ? new it(
    ...
    class ht {
      ...
      static createFromDiffResult(e, t, n, i, r, s, o) {
        ...
        if (
          ...
          let l = st(s, a, r, !0).changes;
          o && (l = ut(l)), (c = []);
          for (let e = 0, t = l.length; e < t; e++)
            c.push(lt.createFromDiffChange(l[e], s, a));
        }
        return new ht(a, l, u, h, c);
      }
    }
    class ct {
      constructor(e, t, n) {
        (this.shouldComputeCharChanges = n.shouldComputeCharChanges),
          ...
          (this.original = new ot(e)),
          (this.modified = new ot(t)),
      ...
      _pushTrimWhitespaceCharChange(e, t, n, i, r, s, o) {
        ...
        let a;
        this.shouldComputeCharChanges && (a = [new lt(t, n, t, i, r, s, r, o)]),
          e.push(new ht(t, t, r, r, a));
      }
      _mergeTrimWhitespaceCharChange(e, t, n, i, r, s, o) {
        ...
        return (
          ...
          this.shouldComputeCharChanges &&
            l.charChanges &&
            l.charChanges.push(new lt(t, n, t, i, r, s, r, o)),
          !0)
        );
      }
    }
    ...
    function Lt(e = '') {
      let t = '(-?\\d*\\.\\d\\w*)|([^';
      for (const n of St) e.indexOf(n) >= 0 || (t += '\\' + n);
    ...
    const Et = { maxLen: 1e3, windowSize: 15, timeBudget: 150 };
    function wt(e, t, n, i, r = Et) {
      if (n.length > r.maxLen) {
        let s = e - r.maxLen / 2;
        return (
          s < 0 ? (s = 0) : (i += s),
          (n = n.substring(s, e + r.maxLen / 2)),
          wt(e, t, n, i, r)
        );
      }
      const s = Date.now(),
      ...
      let a = -1,
        l = null;
      for (let u = 1; ; u++) {
        if (Date.now() - s >= r.timeBudget) break;
        const e = o - r.windowSize * u;
    ...
    class vt {
      constructor(e) {
        ...
        (this._defaultValue = t),
          (this._asciiMap = vt._createAsciiMap(t)),
          (this._map = new Map());
      }
    ...
    function Vt() {
      if (null === Rt) {
        ...
        const e =
          ' \t<>\'"\u3001\u3002\uff61\uff64\uff0c\uff0e\uff1a\uff1b\u2018\u3008\u300c\u300e\u3014\uff08\uff3b\uff5b\uff62\uff63\uff5d\uff3d\uff09\u3015\u300f\u300d\u3009\u2019\uff40\uff5e\u2026';
        for (let n = 0; n < e.length; n++) Rt.set(e.charCodeAt(n), 1);
        const t = '.,;';
        for (let n = 0; n < t.length; n++) Rt.set(t.charCodeAt(n), 2);
      }
      return Rt;
    }
    class kt {
        ...
        for (let r = 1, s = e.getLineCount(); r <= s; r++) {
          ...
          while (a < o) {
            ...
            if (13 === h) {
              ...
              1 === t && (i.push(kt._createLink(n, s, r, l, a)), (e = !0));
            } else if (12 === h) {
              let t;
          ...
          13 === h && i.push(kt._createLink(n, s, r, l, o));
        }
        return i;
      }
    }
    ...
    It.INSTANCE = new It();
    const xt = Object.freeze(function (e, t) {
    ...
    (function (e) {
      ...
      (e.isCancellationToken = t),
        (e.None = Object.freeze({
          ...
          onCancellationRequested: O.None,
        })),
        (e.Cancelled = Object.freeze({
          isCancellationRequested: !0,
          onCancellationRequested: xt,
        }));
    })(Dt || (Dt = {}));
    class Ft {
      constructor() {
    ...
    const qt = new Bt(),
      ...
      Yt = [],
      Xt = [];
    for (let $n = 0; $n <= 193; $n++) Yt[$n] = -1;
    for (let $n = 0; $n <= 126; $n++) Xt[$n] = -1;
    var Jt,
      Zt,
      en,
      tn,
    ...
    (function () {
      ...
      for (const r of t) {
        ...
        if (
          ...
          qt.define(a, l), Ht.define(a, c || l), Wt.define(a, d || c || l);
        }
        u && ($t[u] = a), h && (jt[h] = a);
      }
      Xt[3] = 46;
      ...
      (function (e) {
        ...
        function i(e) {
          return Ht.keyCodeToStr(e);
        }
        function r(e) {
          return Wt.keyCodeToStr(e);
        }
        function s(e) {
          return Ht.strToKeyCode(e) || Wt.strToKeyCode(e);
        }
        function o(e) {
    ...
    class In extends it {
      ...
      equalsSelection(e) {
        return In.selectionsEqual(this, e);
      }
      ...
      setEndPosition(e, t) {
        return 0 === this.getDirection()
          ? new In(this.startLineNumber, this.startColumn, e, t)
          : new In(e, t, this.startLineNumber, this.startColumn);
      }
      getPosition() {
      ...
      setStartPosition(e, t) {
        return 0 === this.getDirection()
          ? new In(e, t, this.endLineNumber, this.endColumn)
          : new In(this.endLineNumber, this.endColumn, e, t);
      }
      static fromPositions(e, t = e) {
        return new In(e.lineNumber, e.column, t.lineNumber, t.column);
      }
      ...
      static createWithDirection(e, t, n, i, r) {
        return 0 === r ? new In(e, t, n, i) : new In(n, i, e, t);
      }
    }
    class xn {
      constructor(e, t, n) {
    ...
    var Un = function (e, t, n, i) {
      ...
      return new (n || (n = Promise))(function (n, s) {
        ...
        function l(e) {
          e.done ? n(e.value) : r(e.value).then(o, a);
        }
    ...
    class Bn extends bt {
      ...
      getWordAtPosition(e, t) {
        let n = wt(e.column, yt(t), this._lines[e.lineNumber - 1], 0);
        return n
          ? new it(e.lineNumber, n.startColumn, e.lineNumber, n.endColumn)
          : null;
      }
      words(e) {
        const t = this._lines,
      ...
      getValueInRange(e) {
        ...
        for (let s = n + 1; s < i; s++) r.push(this._lines[s]);
    ...
    class qn {
      ...
      computeDiff(e, t, n, i) {
        return Un(this, void 0, void 0, function* () {
          ...
          const o = r.getLinesContent(),
            ...
            u = l.computeDiff(),
            h = !(u.changes.length > 0) && this._modelsAreIdentical(r, s);
      ...
      computeMoreMinimalEdits(e, t) {
        return Un(this, void 0, void 0, function* () {
          ...
          t = t.slice(0).sort((e, t) => {
            if (e.range && t.range)
              return it.compareRangesUsingStarts(e.range, t.range);
            let n = e.range ? 0 : 1,
              i = t.range ? 0 : 1;
            return n - i;
          });
          for (let { range: e, text: s, eol: o } of t) {
            if (('number' === typeof o && (r = o), it.isEmpty(e) && !s))
              continue;
            const t = n.getValueInRange(e);
            if (((s = s.replace(/\r\n|\n|\r/g, n.eol)), t === s)) continue;
            if (Math.max(s.length, t.length) > qn._diffLimit) {
              i.push({ range: e, text: s });
              continue;
            }
            const a = de(t, s, !1),
              l = n.offsetAt(it.lift(e).getStartPosition());
            for (const e of a) {
            ...
            if (e)
              for (let n of e.words(s))
                if (
                  n !== t &&
                  isNaN(Number(n)) &&
                  (o.add(n), o.size > qn._suggestionsLimit)
                )
                  break e;
          }
      ...
      navigateValueSet(e, t, n, i, r) {
        return Un(this, void 0, void 0, function* () {
          ...
          let u = s.getValueInRange(l),
            h = It.INSTANCE.navigateValueSet(t, a, l, u, n);
          return h;
        });
      }
      loadForeignModule(e, t, n) {
        const i = (e, t) => this._host.fhr(e, t),
          r = I(n, i);
        let s = { host: r, getMirrorModels: () => this._getModels() };
        return this._foreignModuleFactory
          ? ((this._foreignModule = this._foreignModuleFactory(s, t)),
    ...
    (qn._diffLimit = 1e5),
      (qn._suggestionsLimit = 1e4),
      'function' === typeof importScripts && (A['a'].monaco = Fn());
    let Hn = !1;
    function Wn(e) {
      if (Hn) return;
      Hn = !0;
  ...
  MNsG: function (e, t, n) {
    ...
    (function (e, i) {
      ...
      'undefined' !== typeof p.vscode && 'undefined' !== typeof p.vscode.process
        ? (C = p.vscode.process)
        : 'undefined' !== typeof i && (C = i);
      const b =
        'string' ===
          typeof (null ===
            (r = null === C || void 0 === C ? void 0 : C.versions) ||
          void 0 === r
            ? void 0
            : r.electron) && 'renderer' === C.type;
      if ('object' !== typeof navigator || b)
        if ('object' === typeof C) {
          (u = 'win32' === C.platform),
            (h = 'darwin' === C.platform),
            (c = 'linux' === C.platform),
            (d = c && !!C.env['SNAP'] && !!C.env['SNAP_REVISION']),
            (o = s),
            (_ = s);
          const e = C.env['VSCODE_NLS_CONFIG'];
          if (e)
            try {
              const t = JSON.parse(e),
                n = t.availableLanguages['*'];
              (o = t.locale), (_ = n || s), (a = t._translationsConfigFile);
            } catch (w) {}
          f = !0;
        } else console.error('Unable to resolve platform.');
      else
        (l = navigator.userAgent),
          (u = l.indexOf('Windows') >= 0),
          (h = l.indexOf('Macintosh') >= 0),
          (g =
          ...
          if ('function' === typeof p.postMessage && !p.importScripts) {
            ...
            return (n) => {
              ...
              e.push({ id: i, callback: n }),
                p.postMessage({ vscodeSetImmediateId: i }, '*');
            };
          }
          if (
            'function' ===
            typeof (null === C || void 0 === C ? void 0 : C.nextTick)
          )
